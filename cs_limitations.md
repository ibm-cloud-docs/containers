...
{{site.data.keyword.containerlong_notm}} comes with the following service limitations<ff-roks311-vpc> that apply to all clusters, independent of what infrastructure provider you plan to use</ff-roks311-vpc>. 
{: shortdesc}
