...
| VPC security groups | VPC Gen 2 clusters that run Kubernetes version 1.18 and earlier only: You must [allow inbound traffic requests to node ports on your worker nodes](/docs/containers?topic=containers-vpc-network-policy#security_groups). |
