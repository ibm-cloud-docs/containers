...
If the cluster is in one of the [supported multizone metro cities](/docs/containers/cs_regions.html#zones), yes. See [Updating from stand-alone worker nodes to worker pools](/docs/containers/cs_cluster_update.html#standalone_to_workerpool).
