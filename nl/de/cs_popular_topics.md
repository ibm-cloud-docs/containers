...
<tr>
<td>25. Oktober</td>
<td>[Zone in Mailand verfügbar](cs_regions.html)</td>
...
<tr>
<td>22. Oktober</td>
<td>[Neuer Mehrzonenstandort `lon05` in London](cs_regions.html#zones)</td>
...
<tr>
<td>05. Oktober</td>
<td>Integration mit {{site.data.keyword.keymanagementservicefull}}</td>
<td>Sie können geheime Kubernetes-Schlüssel im Cluster verschlüsseln, indem Sie [{{site.data.keyword.keymanagementserviceshort}} (Beta) aktivieren](cs_encrypt.html#keyprotect).</td>
</tr>
<tr>
<td>04. Oktober</td>
...
<tr>
<td>01. Oktober</td>
<td>[Ressourcengruppen](cs_users.html#resource_groups)</td>
...
<tr>
<td>25. September</td>
<td>[Neue Zonen verfügbar](cs_regions.html)</td>
<td>Jetzt haben Sie noch mehr Optionen zum Bereitstellen von Apps.
<ul><li>Willkommen in San Jose, in dem es jetzt mit `sjc03` und `sjc04` zwei neue Zonen in der Region 'Vereinigte Staaten (Süden)' gibt. Wenn Sie eine Firewall haben, stellen Sie sicher, dass Sie [die Firewall-Ports](cs_firewall.html#firewall) für diese Zone und die anderen Zonen in der Region öffnen, in der sich Ihr Cluster befindet.</li>
<li>Mit den beiden neuen Zonen `tok04` und `tok05` können Sie jetzt in der Region 'Asien-Pazifik (Norden)' in Tokio [Mehrzonencluster erstellen](cs_clusters_planning.html#multizone).</li></ul></td>
</tr>
<tr>
<td>5. September</td>
