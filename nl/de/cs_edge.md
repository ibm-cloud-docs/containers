...
In Kubernetes 1.14 und höher können sowohl öffentliche als auch private NLBs und ALBs auf Edge-Workerknoten bereitgestellt werden. In Kubernetes 1.13 und niedriger können öffentliche und private ALBs und öffentliche NLBs auf Edge-Knoten bereitgestellt werden, aber private NLBs dürfen nur auf Nicht-Edge-Workerknoten in Ihrem Cluster bereitgestellt werden.
{: note}
