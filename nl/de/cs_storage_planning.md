...
<tr>
<td style="text-align:left">Gängige Anwendungsfälle</td>
...
**Hinweis:** Persistente Datenspeicheroptionen sind nur für Standardcluster verfügbar.
...
<td style="text-align:left">Abhängig von DBaaS</ul></td>
</tr>
<tr>
...
<td style="text-align:left">Hoch für Leseoperationen mit niedrigerer Latenz als Block (beim Lesen aus dem lokalen Cache). Nicht vorhersehbar für Schreiboperationen.</td>
...
<td style="text-align:left">Hoch, da die Daten in mindestens drei Kopien gespeichert und innerhalb einer Region oder über mehrere Regionen hinweg verteilt werden. </td>
...
<td style="text-align:left"><ul style="margin:0px 0px 0px 20px; padding:0px"><li style="margin:0px; padding:0px">Schreibintensive Workloads</li><li style="margin:0px; padding:0px">Wahlfreie Schreiboperationen</li><li style="margin:0px; padding:0px">Inkrementelle Datenaktualisierungen</li></ul></td>
