...
Schützen Sie sensible Clusterinformationen, um Datenintegrität zu gewährleisten und zu verhindern, dass Ihre Daten nicht berechtigten Benutzern zugänglich gemacht werden. {: shortdesc}
...
Wenn Sie den Rootschlüssel in Ihrer {{site.data.keyword.keymanagementserviceshort}}-Instanz löschen, können Sie weder auf die Daten in etcd und in den geheimen Schlüsseln im Cluster zugreifen noch diese Daten entfernen. {: important}
