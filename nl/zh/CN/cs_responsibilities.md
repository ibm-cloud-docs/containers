...
- 管理集群的 Kubernetes 主节点的安全性更新、监视和恢复
...
- [确保所有工作程序节点都具有到 Kubernetes 主节点 URL 的网络连接](cs_firewall.html#firewall)<p>**注**：如果工作程序节点同时具有公用和专用 VLAN，那么已配置网络连接。如果工作程序节点设置为仅使用专用 VLAN，那么必须为网络连接配置备用解决方案。有关更多信息，请参阅[工作程序节点的 VLAN 连接](cs_clusters.html#worker_vlan_connection)。</p>
- [Kubernetes 版本更新可用时更新主 kube-apiserver](cs_cluster_update.html#master)
- [使用 `bx cs worker-update` 命令来应用操作系统更新、安全补丁和 Kubernetes 版本更新，从而使工作程序节点保持最新](cs_cluster_update.html#worker_node)
