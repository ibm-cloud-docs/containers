...
# {{site.data.keyword.Bluemix_notm}} 的金融服務使用案例
{: #cs_uc_finance}
...
* [多個地區的高可用性](cs_regions.html#regions-and-zones)
...
其現行環境為 7+ 年以上、內部部署，並且具有有限的運算、儲存空間及 IO 容量。
...
**解決方案模型：隨需應變運算、儲存空間及 IO 服務是視需要在可安全存取內部部署企業資產的公用雲端中執行**
