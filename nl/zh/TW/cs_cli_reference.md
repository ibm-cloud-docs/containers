...
<table summary="Ingress 應用程式負載平衡器 (ALB) 指令">
<col width = 25%>
<col width = 25%>
<col width = 25%>
  <thead>
...
<table>
    <caption>表.瞭解 YAML 檔案元件</caption>
    <thead>
...
<dl>
  ...
  <dt><code>--app-containers</code></dt>
    <dd>選用項目：若要從應用程式轉遞日誌，可以指定包含您應用程式之容器的名稱。您可以使用逗點區隔清單來指定多個容器。如果未指定任何容器，則會從包含您所提供路徑的所有容器轉遞日誌。此選項僅適用於日誌來源 <code>application</code></dt>
...
<dl>
  <dt><code><em>CLUSTER</em></code></dt>
    <dd>必要：您要檢視其過濾器之叢集的名稱或 ID。</dd>
  <dt><code>--id <em>FILTER_ID</em></code></dt>
    <dd>您要檢視的日誌過濾器 ID。</dd>
  <dt><code>--show-matching-configs</code></dt>
    <dd>選用項目：顯示符合您正在檢視之配置的記載配置。</dd>
  <dt><code>--json</code></dt>
    <dd>選用項目：以 JSON 格式列印指令輸出。</dd>
</dl>
