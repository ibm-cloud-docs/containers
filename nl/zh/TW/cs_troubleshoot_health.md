...
<caption>疑難排解未顯示的日誌</caption>
 ...
 <tbody>
  <tr>
    <td>未設定任何記載配置。</td>
    <td>若要傳送日誌，您必須建立記載配置。如果要這麼做，請參閱<a href="/docs/containers?topic=containers-health#logging">配置叢集記載</a>。</td>
  </tr>
  <tr>
...
{: tsSymptoms}
您可以在叢集中設定記載配置，將日誌轉遞至 {{site.data.keyword.loganalysisfull}}。檢視日誌時，您會看到此錯誤訊息或類似的錯誤訊息：
...
{: tsSymptoms}
在叢集中設定記載配置，將日誌轉遞至 {{site.data.keyword.loganalysisfull_notm}}。當您檢視日誌時，看到一則很長的日誌訊息。此外，在 Kibana 中，您可能只能看到日誌訊息的最後 600 - 700 個字元。
