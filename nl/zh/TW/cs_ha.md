...
{: important}
在執行 Kubbernets 1.10 版或更新版本的叢集裡，主節點具有高可用性，且會在個別主機上包含 Kubernetes API 伺服器、etcd、排程器及控制器管理程式的抄本，來防範在主節點更新這類期間發生運作中斷。</p><p>若要防範叢集主節點發生區域失敗，您可以：<ul><li>建立多區域叢集，以將主節點分散在各區域之中。</li><li>在另一個區域設定第二個叢集。</li></ul></p>
