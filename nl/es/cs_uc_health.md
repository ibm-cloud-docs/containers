...
* Sus aplicaciones personalizadas y de oficina y frontal se distribuyen de forma local en imágenes monolíticas de máquina virtual.
...
* Habilitar el escalado según demanda de la capacidad de cálculo para cargas de trabajo de proceso por lotes y otras cargas de trabajo de oficina que se ejecutan con poca frecuencia.
...
{{site.data.keyword.cloudant}} es una moderna base de datos NoSQL que se adapta a muchos casos de uso controlados por datos: desde el par clave-valor hasta el almacenamiento y consulta complejos de datos orientados a documentos. Para minimizar las consultas a las bases de datos relacionales de oficina, se utiliza {{site.data.keyword.cloudant}} para almacenar en memoria caché los datos de sesión de usuario entre las apps. Estas opciones mejoran el rendimiento y la usabilidad para el usuario final entre las apps de {{site.data.keyword.containerlong_notm}}.
...
**Resultados**
* Con los kits de inicio, {{site.data.keyword.containerlong_notm}} y las herramientas de IBM CI/CD, los desarrolladores globales trabajan en instituciones y desarrollan aplicaciones de investigación en colaboración, con herramientas interoperables con las que están familiarizados. 
