...
-  [Instale la CLI de IBM Cloud, el plugin de {{site.data.keyword.containerlong_notm}} y la CLI de Kubernetes](cs_cli_install.html#cs_cli_install_steps). Asegúrese de instalar una versión de la CLI de `kubectl` que coincida con la versión de Kubernetes de su clúster.
...
1. Instale Istio utilizando el [diagrama de Helm de Istio de IBM ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](https://console.bluemix.net/containers-kubernetes/solutions/helm-charts/ibm-charts/ibm-istio).
    1. [Configure Helm en el clúster y añada el repositorio `ibm-charts` a la instancia de Helm](cs_integrations.html#helm).
...
3. Si ha utilizado Helm 2.9 o anterior:
    1. Suprima el recurso del trabajo adicional.
      ```
      kubectl -n istio-system delete job --all
      ```
      {: pre}
    2. Opcional: suprima las definiciones de recursos personalizados de Istio.
      ```
...
* ¿Está pensando en exponer su app tanto con {{site.data.keyword.containerlong_notm}} como con Istio? Vea cómo conectar el ALB Ingress de {{site.data.keyword.containerlong_notm}} y una pasarela Istio en esta [publicación del blog ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo") ](https://www.ibm.com/blogs/bluemix/2018/09/transitioning-your-service-mesh-from-ibm-cloud-kubernetes-service-ingress-to-istio-ingress/).
