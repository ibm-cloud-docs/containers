...
* [Se proporciona acceso a datos públicos con {{site.data.keyword.cos_full_notm}}](https://console.bluemix.net/docs/services/cloud-object-storage/about-cos.html#about-ibm-cloud-object-storage)
...
Debido a que la compañía naviera también quiere asociarse con otros puertos, la seguridad de las apps resulta crucial. Los manifiestos de transporte marítimo la información aduanera son altamente confidenciales. Desde el punto de vista de la seguridad, Vulnerability Advisor ofrece los siguientes escaneos: 
