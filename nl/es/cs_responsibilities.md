...
# Responsabilidades del usuario al utilizar {{site.data.keyword.containerlong_notm}}
Conozca las responsabilidades de gestión del clúster y los términos y las condiciones existentes para utilizar {{site.data.keyword.containerlong}}. {:shortdesc}
...
- Gestionar las actualizaciones de seguridad, la supervisión y la recuperación del maestro de Kubernetes para el clúster
...
- [El mantenimiento de los nodos trabajadores con el mandato `bx cs worker-update` para aplicar actualizaciones de versión de Kubernetes, parches de seguridad y actualizaciones del sistema operativo](cs_cluster_update.html#worker_node)
