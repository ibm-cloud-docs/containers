...
<td>Puede aumentar el tamaño de almacenamiento y las IOPS asignadas [modificando el volumen existente](cs_storage_file.html#change_storage_configuration). </td>
</tr>
<tr>
<td>Almacenamiento en bloque</td>
<td>Puede aumentar el tamaño de almacenamiento y las IOPS asignadas [modificando el volumen existente](cs_storage_block.html#change_storage_configuration). </td>
</tr>
<tr>
