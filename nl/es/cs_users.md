...
Como administrador del clúster, puede ser difícil mantener un seguimiento de las solicitudes de acceso. Establecer un patrón de comunicación para las solicitudes de acceso es esencial para mantener la seguridad de su clúster.
{: shortdesc}

Para garantizar que las personas adecuadas tienen el acceso correcto, sea muy claro con aquellas personas que tendrán acceso al clúster en sus políticas para solicitar acceso u obteniendo ayuda con las tareas más habituales. 
...
<dl>
  <dt>Políticas de identidad y gestión de acceso (IAM (Identity and Access Management)) </dt>
    <dd><p><em>Plataforma</em>: Puede determinar las acciones que las personas pueden realizar en un clúster de {{site.data.keyword.containershort_notm}}. Puede establecer estas políticas por región. Ejemplos de acciones: crear o eliminar clústeres o añadir nodos trabajadores adicionales. Estas políticas deben establecerse en conjunto con las políticas de infraestructura.</p>
    <p><em>Infraestructura</em>: Puede determinar los niveles de acceso para su infraestructura como, por ejemplo, máquinas de nodo, red o recursos de almacenamiento de clúster. La misma política se aplica independientemente de si el usuario realiza una solicitud desde la GUI de {{site.data.keyword.containershort_notm}} o mediante la CLI; incluso cuando las acciones se completan en la infraestructura de IBM Cloud (SoftLayer). Debe establecer este tipo de política junto con las políticas de acceso de la plataforma {{site.data.keyword.containershort_notm}}. Para obtener más información sobre los roles disponibles, consulte [permisos de infraestructura](/docs/iam/infrastructureaccess.html#infrapermission). </p></dd>
  <dt>Roles de control de acceso basado en recursos (RBAC (Resource Based Access Control)) de Kubernetes</dt>
    <dd>Cada usuario asignado a la política de acceso de la plataforma, se le asigna también de forma automática un rol de Kubernetes. En Kubernetes, el [Role Based Access Control (RBAC) ![Icono de enlace externo](../icons/launch-glyph.svg "Icono de enlace externo")](https://kubernetes.io/docs/admin/authorization/rbac/#api-overview) determina las acciones que el usuario puede realizar en los recursos dentro de un clúster. Los roles de RBAC se configuran automáticamente para el espacio de nombres <code>default</code>, sin embargo como administrador del clúster, puede asignar roles a otros espacios de nombres. </dd>
  <dt>Cloud Foundry</dt>
    <dd>Actualmente no es posible gestionar todos los servicios con Cloud IAM. Si está utilizando uno de estos servicios, puede continuar utilizando los [roles de usuario de Cloud Foundry](/docs/iam/cfaccess.html#cfaccess) para controlar el acceso a los servicios. </dd>
</dl>
...
<table>
  ...
  <tr>
    <td>Editor</td>
    <td>Puede enlazar o desenlazar un servicio IBM Cloud a un clúster, o puede crear un webhook. </td>
    <td>Editar</td>
  </tr>
  <tr>
    <td>Operador</td>
  ...
  <tr>
    <td>Administrador</td>
    <td>Puede crear y eliminar clústeres. Puede editar políticas de acceso para otros en el nivel de cuenta para el servicio y la infraestructura.</td>
...
<table>
  ...
  <tr>
    ...
    <td>Puede ver detalles de la infraestructura. Puede ver un resumen de la cuenta, incluidas facturas y pagos. </td>
  </tr>
  <tr>
...
<table>
  ...
  <tr>
    <td>Ver</td>
    <td>Puede ver recursos dentro del espacio de nombres predeterminado.</td>
  </tr>
  <tr>
    <td>Editar</td>
