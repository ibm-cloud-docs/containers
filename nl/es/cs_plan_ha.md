...
Diseñe su clúster estándar OpenShift o de la comunidad Kubernetes de modo que obtenga la máxima disponibilidad y capacidad de su app con {{site.data.keyword.containerlong}}.
{: shortdesc}
...
4.  Configure un equilibrador de carga global utilizando {{site.data.keyword.cloud_notm}} Internet Services (CIS) o configure su propio equilibrador de carga global.
