...
# Casos de uso de {{site.data.keyword.Bluemix_notm}} en el sector de servicios financieros
{: #cs_uc_finance}
...
* [Varias regiones para alta disponibilidad ](cs_regions.html#regions-and-zones)
