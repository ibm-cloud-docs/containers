...
Antes de empezar, asegúrese de tener las [políticas de acceso de {{site.data.keyword.cloud_notm}} IAM](/docs/containers?topic=containers-users#platform) siguientes:
