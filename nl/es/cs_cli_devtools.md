...
Defina las credenciales de cuenta de la infraestructura de IBM Cloud (SoftLayer) para su cuenta de {{site.data.keyword.containerlong_notm}}.
...
No puede definir varias credenciales para una cuenta de {{site.data.keyword.containerlong_notm}}. Cada cuenta de {{site.data.keyword.containerlong_notm}} está vinculada a un portafolio de la infraestructura de IBM Cloud (SoftLayer).
...
Elimine las credenciales de cuenta de la infraestructura de IBM Cloud (SoftLayer) de su cuenta de {{site.data.keyword.containerlong_notm}}.
