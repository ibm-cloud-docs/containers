...
- Comprobar de forma mensual la disponibilidad de parches de seguridad y del sistema operativo para [actualizar los nodos trabajadores](cs_cli_reference.html#cs_worker_update). 
