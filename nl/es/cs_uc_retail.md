...
* [{{site.data.keyword.cos_full}} para almacenar datos de forma permanente y sincronizarlos entre apps](https://console.bluemix.net/docs/tutorials/pub-sub-object-storage.html#asynchronous-data-processing-using-object-storage-and-pub-sub-messaging)
...
Tecnologías clave:    
* [Escalado horizontal para acelerar el desarrollo](cs_app.html#highly_available_apps) 
* [Clústeres que se adaptan a las diversas necesidades de CPU, RAM y almacenamiento](cs_clusters_planning.html#shared_dedicated_node)
* [Datos valiosos sobre tendencias del mercado con Watson Discovery](https://www.ibm.com/watson/services/discovery/)
* [Herramientas nativas de DevOps, que incluyen cadenas de herramientas abiertas en {{site.data.keyword.contdelivery_full}}](https://www.ibm.com/cloud/garage/toolchains/)
* [Gestión de inventario con {{site.data.keyword.messagehub_full}}](https://console.bluemix.net/docs/services/MessageHub/messagehub010.html#about)
...
* Combinar el análisis de inventario y las apps para móviles con microservicios y desplegarlos en contenedores en {{site.data.keyword.containerlong_notm}}. 
* Proporcionar paneles de control de DevOps estandarizados a través de Kubernetes.
