...
2. Si el clúster está en un grupo de recursos distinto de `default`, elija como destino dicho grupo de recursos. **Nota**: debe tener al menos el [rol de **Visor**](cs_users.html#platform) para el grupo de recursos.
   ```
