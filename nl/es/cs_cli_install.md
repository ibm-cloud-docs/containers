...
-   CLI de {{site.data.keyword.Bluemix_notm}} versión 0.8.0 o posterior
-   Plug-in de {{site.data.keyword.containerlong_notm}}
-   CLI de Kubernetes versión 1.10.7 o posterior
