...
<img src="images/cs_security.png" width="400" alt="{{site.data.keyword.containershort_notm}} seguridad del clúster" style="width:400px; border-style: none"/>
  ...
  <caption>Funciones de seguridad</caption>
  <thead>
...
<dl>
  <dt>Aislamiento de la infraestructura de cálculo, red y almacenamiento</dt>
    <dd>Cuando crea un clúster, se suministran máquinas virtuales como nodos trabajadores en la cuenta de infraestructura de IBM Cloud (SoftLayer) del cliente o en la cuenta dedicada de infraestructura de IBM Cloud (SoftLayer) por IBM.
...
* Para permitir la comunicación entre el Kubernetes maestro y los nodos trabajadores cuando hay un cortafuegos configurado para los nodos trabajadores o los valores del cortafuegos están personalizados en su cuenta de infraestructura de IBM Cloud (SoftLayer)
