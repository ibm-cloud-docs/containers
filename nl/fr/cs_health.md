...
1. Vérifiez que vous disposez du [rôle de plateforme {{site.data.keyword.cloud_notm}} IAM **Editeur** ou **Administrateur**](/docs/containers?topic=containers-users#platform). 
