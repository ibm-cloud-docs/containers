...
## Une enseigne partage des données à l'aide d'API avec des partenaires mondiaux pour gérer les ventes omnicanal 
{: #uc_data-share}
...
* [{{site.data.keyword.cos_full}} pour conserver et synchroniser les données sur plusieurs applications](https://console.bluemix.net/docs/tutorials/pub-sub-object-storage.html#asynchronous-data-processing-using-object-storage-and-pub-sub-messaging)
...
* Cette capacité à changer de marque implique que l'écosystème de l'enseigne soit en connectivité avec des partenaires. Le cloud peut ensuite apporter une valeur ajoutée aux partenaires, aux consommateurs et à d'autres acteurs externes. 
...
{{site.data.keyword.messagehub_full}} fait office de plateforme d'événements JIT (juste-à-temps) pour rapatrier les informations qui évoluent rapidement des systèmes d'inventaire des partenaires sur {{site.data.keyword.cos_full}}. 
...
* {{site.data.keyword.cos_full}} associé à {{site.data.keyword.messagehub_full}} fournit un stockage de données d'historique en temps réel pour que les offres de ventes croisées correspondent au stock disponible chez les partenaires. 
* Les API permettent aux partenaires de l'enseigne de partager des données dans leurs applications B2B et d'e-commerce.
...
* L'enseigne et ses partenaires ont un accès immédiat au stock disponible et au calendrier de livraison, en utilisant des API. 
...
Technologies clés :    
* [Mise à l'échelle horizontale pour accélérer le développement](cs_app.html#highly_available_apps) 
* [Clusters adaptés aux différents besoins en matière de stockage, d'UC et de mémoire RAM](cs_clusters_planning.html#shared_dedicated_node)
* [Connaissances des tendances du marché avec Watson Discovery](https://www.ibm.com/watson/services/discovery/)
* [Outils natifs DevOps, notamment des chaînes d'outils ouvertes dans {{site.data.keyword.contdelivery_full}}](https://www.ibm.com/cloud/garage/toolchains/)
* [Gestion des stocks avec {{site.data.keyword.messagehub_full}}](https://console.bluemix.net/docs/services/MessageHub/messagehub010.html#about)
...
* La pression de la concurrence des commerces en ligne et des grandes surfaces a rompu les modèles d'épicerie classiques. Les ventes déclinent, comme en témoigne la baisse de fréquentation dans les magasins. 
...
* Organiser l'architecture de l'analyse des stocks et des applications mobiles sous forme de microservices et les déployer dans des conteneurs d'{{site.data.keyword.containerlong_notm}}. 
* Fournir des tableaux de bord DevOps normalisés via Kubernetes.
