...
* INVENTAIRE : application pour l'écosystème des partenaires commerciaux qui consolide et communique son stock, notamment lors de l'introduction de nouveaux produits, en incluant des API réutilisables par les partenaires dans les applications B2B et de vente au détail
