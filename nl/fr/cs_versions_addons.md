...
<td><ul>
<li>Ajout d'une vérification de disponibilité pour les redémarrages de pod d'ALB afin d'empêcher toute perte de demande. Cette vérification empêche les pods d'ALB de tenter d'acheminer les demandes de trafic tant que les fichiers de ressources Ingress n'ont pas tous été analysés, pendant une durée pouvant atteindre 5 minutes. Pour plus d'informations, y compris sur les étapes permettant de modifier les valeurs de délai d'attente par défaut, voir [Augmentation de la durée de vérification de la disponibilité lors du démarrage des pods d'ALB](/docs/containers?topic=containers-ingress-settings#readiness-check). </li>
<li>Correction des vulnérabilités `patch` GNU pour [CVE-2019-13636 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-13636) et [CVE-2019-13638 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-13638). </li>
</ul></td>
<td>-</td>
</tr>
<tr>
...
<td><ul>
<li>Correction des vulnérabilités `rbash` pour [CVE-2016-3189 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-9924). </li>
<li>Retrait des packages apt suivants de l'image `nginx-ingress` : `curl`, `bash`, `vim`, `tcpdump` et `ca-certificates`. </li></ul></td>
<td>-</td>
</tr>
<tr>
<td>497 / 334</td>
<td>14 juillet 2019</td>
<td><ul>
<li>Ajout du paramètre [`upstream-keepalive-timeout`](/docs/containers?topic=containers-ingress_annotation#upstream-keepalive-timeout) permettant de définir la durée maximale d'ouverture d'une connexion persistante entre le serveur proxy d'ALB et le serveur en amont de votre application de back end. </li>
<li>Ajout de la prise en charge pour la directive [`reuse-port`](/docs/containers?topic=containers-ingress-settings#reuse-port) afin d'augmenter le nombre de programmes d'écoute de socket ALB d'un par cluster à un par noeud worker. </li>
<li>Retrait de la mise à jour redondante de l'équilibreur de charge qui expose un ALB lorsqu'un numéro de port est modifié. </li>
<li>Correction des vulnérabilités `bzip2` pour [CVE-2016-3189 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2016-3189) et [CVE-2019-12900 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-12900). </li>
<li>Correction des vulnérabilités Expat pour [CVE-2018-20843 ![Icône de lien externen](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-20843). </li>
</ul></td>
<td>-</td>
</tr>
<tr>
<td>477 / 331</td>
<td>24 juin 2019</td>
<td>Correction des vulnérabilités SQLite pour [CVE-2016-6153 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2016-6153), [CVE-2017-10989 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-10989), [CVE-2017-13685 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-13685), [CVE-2017-2518 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-2518), [CVE-2017-2519 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-2519), [CVE-2017-2520 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-2520), [CVE-2018-20346 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-20346), [CVE-2018-20505 ![Icône de  lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-20505), [CVE-2018-20506 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-20506), [CVE-2019-8457 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-8457), [CVE-2019-9936 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-9936), and [CVE-2019-9937 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-9937).
</td>
<td>-</td>
</tr>
<tr>
...
<td>18 juin 2019</td>
<td><ul>
<li>Correction des vulnérabilités Vim pour [CVE-2019-5953 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-5953) et [CVE-2019-12735 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-12735). </li>
<li>Mise à jour de la version NGINX des équilibreurs de charge d'application (ALB) vers 1.15.12.</li></ul>
</td>
<td>-</td>
</tr>
<tr>
...
<td>457 / 329</td>
<td>23 mai 2019</td>
<td>Correction des vulnérabilités Go pour [CVE-2019-11841 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-11841). </td>
<td>-</td>
</tr>
<tr>
<td>423 / 329</td>
...
<td>411 / 306</td>
<td>22 mars 2019</td>
<td>Mise à jour de la version Go vers 1.12.1.</td>
<td>-</td>
</tr>
<tr>
<td>410/305</td>
...
<td>19 fév. 2019</td>
<td><ul>
<li>Mise à jour de la version Go vers 1.11.5.</li>
<li>Correction de vulnérabilités pour les analyses d'image.</li>
</ul></td>
<td>-</td>
</tr>
...
<td>404 / 300</td>
<td>31 jan. 2019</td>
<td>Mise à jour de la version Go vers 1.11.4.</td>
<td>-</td>
</tr>
<tr>
<td>403 / 295</td>
<td>23 jan. 2019</td>
<td><ul>
<li>Mise à jour de la version NGINX des équilibreurs de charge d'application (ALB) vers 1.15.2.</li>
...
<td>Désactivation de TLS 1.0 et 1.1 par défaut. Si les clients qui se connectent à vos applications prennent en charge TLS 1.2, aucune action n'est requise. Si vous avez toujours des clients qui nécessitent la prise en charge de TLS 1.0 ou 1.1, activez manuellement les versions TLS requises en suivant [ces étapes](/docs/containers?topic=containers-ingress-settings#ssl_protocols_ciphers). Pour plus d'informations sur l'affichage des versions TLS utilisées par vos clients pour accéder à vos applications, voir cet [article du blogue {{site.data.keyword.cloud_notm}}](https://www.ibm.com/blogs/bluemix/2018/11/ibm-cloud-kubernetes-service-alb-update-tls-1-0-and-1-1-disabled-by-default/). </td>
</tr>
<tr>
<td>393 / 291</td>
<td>9 jan. 2019</td>
...
<td>Mise à jour de packages Alpine pour [CVE-2019-8905 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-8905), [CVE-2019-8906 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-8906) et [CVE-2019-8907 ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-8907). </td>
<td>-</td>
</tr>
<tr>
...
<li>Correctifs de bogues mineurs.</li>
</ul></td>
<td>-</td>
</tr>
</tbody>
