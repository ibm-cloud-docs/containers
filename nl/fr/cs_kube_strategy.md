...
{{site.data.keyword.Bluemix_notm}} vous offre la possibilité de choisir une [approche de cloud publique, privée ou hybride](/docs/containers?topic=containers-cs_ov#differentiation) pour vos charges de travail. Le tableau ci-après fournit quelques exemples de types de charge de travail généralement déplacés par les utilisateurs vers les divers types de cloud.
{: shortdesc}

| Charge de travail | Public | Privé | Hybride |
| --- | --- | --- | --- |
...
| Besoins intensifs en termes de capacité d'E-S ou d'unité centrale qui dépassent les types de machine publics | | <img src="images/confirm.svg" width="32" alt="Fonction disponible" style="width:32px;" /> | |
| Applications existantes avec des contraintes et des dépendances de plateforme et d'infrastructure | | <img src="images/confirm.svg" width="32" alt="Fonction disponible" style="width:32px;" /> | <img src="images/confirm.svg" width="32" alt="Fonction disponible" style="width:32px;" /> |
| Applications de propriété avec des conceptions strictes, des règles d'octroi de licence ou des réglementations sévères | | <img src="images/confirm.svg" width="32" alt="Fonction disponible" style="width:32px;" /> | <img src="images/confirm.svg" width="32" alt="Fonction disponible" style="width:32px;" /> |
| Mise à l'échelle d'applications dans le cloud public et synchronisation des données sur une base de données privée sur site | | | <img src="images/confirm.svg" width="32" alt="Fonction disponible" style="width:32px;" /> |
{: caption="Les implémentations d'{{site.data.keyword.Bluemix_notm}} prennent en charge vos charges de travail" caption-side="top"}

**Prêt à exécuter vos charges de travail dans le cloud public ?**</br>
...
**Le cloud privé vous intéresse ?**</br>
...
* Pour obtenir une meilleure compréhension de vos applications existantes et de l'environnement de prise en charge, utilisez [IBM Transformation Advisor ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://www.ibm.com/support/knowledgecenter/en/SSBS6K_2.1.0/featured_applications/transformation_advisor.html).
* Pour vous aider à déterminer si vous êtes prêt à adopter un cloud et pour obtenir un organigramme de cloud, voir les [services de conseil {{site.data.keyword.Bluemix_notm}} ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://www.ibm.com/us-en/marketplace/cloud-consulting-services).
* Afin d'aider les développeurs à créer des services pour {{site.data.keyword.Bluemix_notm}} Private, voir [IBM Microclimate ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://www.ibm.com/us-en/marketplace/microclimate).
* Pour la mise à disposition multi-cloud, pensez à utiliser [{{site.data.keyword.Bluemix_notm}} Automation Manager ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://www.ibm.com/us-en/marketplace/cognitive-automation).
* Pour gérer plusieurs clusters Kubernetes en cloud, par exemple, dans {{site.data.keyword.Bluemix_notm}} Public et {{site.data.keyword.Bluemix_notm}} Private, voir [IBM Multicloud Manager ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://www.ibm.com/support/knowledgecenter/en/SSBS6K_3.1.0/mcm/getting_started/introduction.html).

**Vous souhaitez utiliser un cloud public et un cloud privé ?**</br>
Commencez par configurer un compte {{site.data.keyword.Bluemix_notm}} Private. Ensuite, reportez-vous à la rubrique [Utilisation d'{{site.data.keyword.containerlong_notm}} avec {{site.data.keyword.Bluemix_notm}} Private](/docs/containers?topic=containers-hybrid_iks_icp) pour connecter votre environnement {{site.data.keyword.Bluemix_notm}} Private à un cluster dans {{site.data.keyword.Bluemix_notm}} Public.
...
1.  Planifiez votre stratégie pour des [clusters hautement disponibles](/docs/containers?topic=containers-plan_clusters#ha_clusters), par exemple, faites un choix entre des clusters à zone unique ou à zones multiples. 
...
2.  Alignez la taille d'application et la capacité de noeud worker avec l'une des [versions de noeud worker disponibles](/docs/containers?topic=containers-plan_clusters#shared_dedicated_node). Pour voir les versions disponibles dans une zone, exécutez `ibmcloud ks machine-types <zone>`.
...
Bien qu'aucun système ne soit complètement infaillible, vous pouvez prendre des mesures pour augmenter la haute disponibilité de vos applications et services dans {{site.data.keyword.containerlong_notm}}. {:shortdesc}
...
* [Créez des clusters à zones multiples](/docs/containers?topic=containers-plan_clusters#ha_clusters).
...
Un [pod ![Icône de lien externe](../icons/launch-glyph.svg "Icône de lien externe")](https://kubernetes.io/docs/concepts/workloads/pods/pod/) est la plus petite unité déployable pouvant être gérée par Kubernetes. Vous placez votre conteneur (ou un groupe de conteneurs) dans un pod et utilisez le fichier de configuration de pod pour indiquer au pod comment configurer le conteneur et partager des ressources avec d'autres pods. Tout les éléments que vous placez dans un pod sont exécutés dans un contexte partagé, ce qui signifie qu'ils fonctionnent de manière synchronisée sur la même machine virtuelle ou physique.
{: shortdesc}
