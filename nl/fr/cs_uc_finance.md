...
# Cas d'utilisation d'{{site.data.keyword.Bluemix_notm}} pour les services financiers
{: #cs_uc_finance}
...
* [Plusieurs régions pour assurer une haute disponibilité](cs_regions.html#regions-and-zones)
