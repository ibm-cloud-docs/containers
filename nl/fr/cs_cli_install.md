...
1.  Connectez-vous à l'interface de ligne de commande {{site.data.keyword.cloud_notm}}. A l'invite, entrez vos données d'identification {{site.data.keyword.cloud_notm}}.
