...
- [API de REST para efetuar login em clusters do Kubernetes ![Ícone de link externo](../icons/launch-glyph.svg "Ícone de link externo")](https://us-south.containers.bluemix.net/swagger-logging/)
- [API de REST para gerenciar balanceadores de carga do aplicativo de Ingresso em clusters do Kubernetes ![Ícone de link externo](../icons/launch-glyph.svg "Ícone de link externo")](https://us-south.containers.bluemix.net/swagger-alb-api/)
...
**Links relacionados a contêineres únicos e escaláveis (descontinuado)**
