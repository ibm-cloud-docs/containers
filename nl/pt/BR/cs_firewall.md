...
2. Se o cluster estiver em um grupo de recursos diferente de `default`, destine esse grupo de recursos. **Nota**: deve-se ter pelo menos a [função **Visualizador**](cs_users.html#platform) para o grupo de recursos.
   ```
