...
Para obter mais informações sobre como proteger o seu cluster, consulte [Segurança para o {{site.data.keyword.containerlong_notm}}](/docs/containers?topic=containers-security#security).
...
### Acessando o seu registro com credenciais que são armazenadas em um segredo de pull de imagem do Kubernetes
{: #imagepullsecret}
...
* Em uma imagem em seu registro do {{site.data.keyword.registryshort_notm}} que está armazenada em uma região do {{site.data.keyword.cloud_notm}} ou em uma conta do {{site.data.keyword.cloud_notm}} diferente.
...
Quando você ativa o {{site.data.keyword.keymanagementserviceshort}} em seu cluster, sua própria chave raiz é usada para criptografar dados em etcd, incluindo os segredos do LUKS. Você obtém mais controle sobre seus dados sensíveis criptografando os segredos com sua chave raiz. O uso de sua própria criptografia inclui uma camada de segurança para seus dados etcd e segredos do Kubernetes e fornece um controle mais granular de quem pode acessar informações de cluster sensíveis. Se você precisar remover irreversivelmente o acesso para etcd ou seus segredos, será possível excluir a chave raiz.
...
## Criptografando dados usando o IBM Cloud Data Shield
{: #datashield}
...
Para iniciar, provisione um cluster de trabalhador bare metal ativado para SGX com tipo de máquina: mb2c.4x32 e consulte [os docs do {{site.data.keyword.datashield_short}}](/docs/services/data-shield?topic=data-shield-getting-started).
