...
Para saber mais sobre a terminologia do Kubernetes, tente o <a href="cs_tutorials.html#cs_cluster_tutorial" target="_blank">tutorial</a>.</dd>
</dl>
...
Cada cluster é implementado em máquinas virtuais compartilhadas ou dedicadas que fornecem Kubernetes nativos e recursos incluídos da {{site.data.keyword.IBM_notm}}.
{:shortdesc}
...
de desenvolvimento.</li><li>Provisione um mestre do Kubernetes dedicado e seguro, nós do trabalhador, redes virtuais e armazenamento usando os recursos fornecidos pelo IBM Bluemix Infrastructure (SoftLayer).</li><li>Armazene dados persistentes, compartilhar dados entre pods do Kubernetes e restaure dados quando necessário com o
...
*   O {{site.data.keyword.IBM_notm}} possui e gerencia a conta do IBM Bluemix Infrastructure (SoftLayer) em que os nós do trabalhador, VLANs e sub-redes são implementados, em vez de em uma conta que é pertencente a você.
...
<img usemap="#dedicated_options" border="0" class="image" id="cs_ov_environments__image_hjb_4ln_j1b" src="images/cs_dedicated_options.png" width="600" alt="Com o {{site.data.keyword.Bluemix_notm}} Dedicated, é possível criar clusters do Kubernetes ou migrar grupos de contêiner únicos e escaláveis para clusters. " style="width:600px;" />
    <map name="dedicated_options" id="dedicated_options">
    <area href="#setup_dedicated" alt="Configurando {{site.data.keyword.containershort_notm}} em{{site.data.keyword.Bluemix_notm}} Dedicated (Beta encerrado)" title="Configurando {{site.data.keyword.containershort_notm}} on {{site.data.keyword.Bluemix_notm}} Dedicated (Beta encerrado)" shape="rect" coords="-5, -15, 100, 153" />
    <area href="container_index.html#dedicated" alt="Introdução aos clusters do Kubernetes em {{site.data.keyword.Bluemix_notm}} Dedicated (Beta encerrado)" title="Introdução aos clusters do Kubernetes em {{site.data.keyword.Bluemix_notm}} Dedicated (Beta encerrado)" shape="rect" coords="153, -10, 276, 182" />
...
Kubernetes**.
    Para obter mais informações sobre como criar um cluster, consulte [Criando clusters do Kubernetes por meio da GUI no {{site.data.keyword.Bluemix_notm}} Dedicated (Beta encerrado)](cs_cluster.html#creating_ui_dedicated).
