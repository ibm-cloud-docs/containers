...
4. Escolheu a  [ classe de armazenamento ](cs_storage_cos.html#storageclass_reference) apropriada. 
...
Ao fazer upload de um arquivo usando o plug-in do {{site.data.keyword.cos_full_notm}}, a permissão para o arquivo é preservada e não mudada. 
