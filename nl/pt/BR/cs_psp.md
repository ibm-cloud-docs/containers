...
Os recursos RBAC padrão `privileged-psp-user` e `restricted-psp-user` referem-se às políticas de segurança de pod que são configuradas pela {{site.data.keyword.IBM_notm}}. 
