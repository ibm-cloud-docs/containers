...
## A companhia de navegação aumenta a disponibilidade de sistemas mundiais para o ecossistema do parceiro
{: #uc_shipping}
...
* [ {{site.data.keyword.messagehub_full}}  para alimentar dados do evento para apps ](https://console.bluemix.net/docs/services/MessageHub/messagehub010.html#about)

**Contexto: a companhia de navegação aumenta a disponibilidade de sistemas mundiais para o ecossistema do parceiro**
...
A companhia aérea deseja projetar uma cultura aberta que coloca as pessoas em primeiro plano. O Exec de RH está bem ciente de que um foco no incentivo e retenção de talentos afeta a lucratividade da companhia aérea. Assim, o lançamento anual de benefícios é um aspecto chave da estimação de uma cultura centrada no funcionário. 
