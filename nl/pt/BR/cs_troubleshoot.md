...
- Verifique mensalmente se há correções de segurança e de sistema operacional disponíveis para [atualizar os nós do trabalhador](cs_cli_reference.html#cs_worker_update).
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>A infraestrutura do IBM Cloud (SoftLayer) não está configurada para pedir recursos de cálculo no data center selecionado. Entre em contato com o [suporte do {{site.data.keyword.Bluemix_notm}}](#ts_getting_help) para verificar se a sua conta está configurada corretamente.</td>
       </tr>
       <tr>
