    ...
    <tbody>
      ...
      <tr>
       ...
       <tr>
        ...
        <td>IBM Cloud 인프라(SoftLayer) 포트폴리오에서 조치를 수행하는 데 필요한 권한이 없거나 잘못된 인프라 인증 정보를 사용 중입니다. [표준 Kubernetes 클러스터를 작성하기 위해 IBM Cloud 인프라(SoftLayer) 포트폴리오에 대한 액세스 구성](cs_troubleshoot_clusters.html#cs_credentials)을 참조하십시오.</td>
      </tr>
      <tr>
