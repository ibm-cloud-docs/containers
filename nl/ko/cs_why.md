...
이러한 {{site.data.keyword.containershort_notm}} 설정 간의 차이점에 대해서는 다음 정보를 검토하십시오. 
...
<col width="78%">
 ...
 <td>[공유 하드웨어, 전용 하드웨어 또는 베어메탈 머신](cs_clusters.html#shared_dedicated_node)의 {{site.data.keyword.Bluemix_notm}} 퍼블릭을 사용하면 {{site.data.keyword.containershort_notm}}를 사용하여 클러스터 내의 앱을 클라우드에서 호스팅할 수 있습니다. {{site.data.keyword.Bluemix_notm}} 퍼블릭의 {{site.data.keyword.containershort_notm}}는 컴퓨팅 호스트의 클러스터에서 컨테이너화된 앱의 배치, 운영, 스케일링 및 모니터링을 자동화하기 위해 Docker 및 Kubernetes 기술, 직관적인 사용자 경험, 기본 제공 보안 및 격리 기능이 결합된 강력한 도구를 제공합니다.
<br><br>자세한 정보는 [{{site.data.keyword.containershort_notm}} 기술](cs_tech.html#ibm-cloud-container-service-technology)을 참조하십시오.
 </td>
 </tr>
 <tr>
 ...
 <td>{{site.data.keyword.Bluemix_notm}} Private은 사용자가 자신의 머신에 로컬로 설치할 수 있는 애플리케이션 플랫폼입니다. 컨테이너화된 온프레미스 앱을 방화벽으로 보호되는 사용자의 고유한 제어 환경에서 개발하고 관리해야 하는 경우에는 {{site.data.keyword.containershort_notm}}를 {{site.data.keyword.Bluemix_notm}} Private에서 사용하도록 선택할 수 있습니다. <br><br>자세한 정보는 [{{site.data.keyword.Bluemix_notm}} Private 제품 정보 ![외부 링크 아이콘](../icons/launch-glyph.svg "외부 링크 아이콘")](https://www.ibm.com/cloud-computing/products/ibm-cloud-private/) 및 [문서 ![외부 링크 아이콘](../icons/launch-glyph.svg "외부 링크 아이콘")](https://www.ibm.com/support/knowledgecenter/en/SSBS6K_1.2.0/kc_welcome_containers.html)를 참조하십시오.
 </td>
 </tr>
 <tr>
 <td>하이브리드 설정
...
|[NodePort 서비스에 의한 안정적이지 않은 IP 주소에 대한 공용 네트워크 앱 액세스](cs_nodeport.html)|<img src="images/confirm.svg" width="32" alt="사용 가능한 기능" style="width:32px;" />|<img src="images/confirm.svg" width="32" alt="사용 가능한 기능" style="width:32px;" />|
...
{: #responsibilities}
**참고**: 이 서비스를 사용할 때의 사용자 책임 및 컨테이너 이용 약관에 대해 알아보려 하십니까? 
