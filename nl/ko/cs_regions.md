...
{{site.data.keyword.Bluemix_notm}}는 전세계적으로 호스팅됩니다. {{site.data.keyword.Bluemix_notm}} 내의 서비스는 글로벌로 사용 가능하거나 특정 지역 내에서 사용 가능할 수 있습니다. {{site.data.keyword.containershort_notm}}에서 Kubernetes 클러스터를 작성할 때 리소스는 클러스터를 배치하는 지역에 남아 있습니다.

![{{site.data.keyword.containershort_notm}} 지역 및 구역](/images/regions-mz.png)

_{{site.data.keyword.containershort_notm}} 지역 및 구역_
...
## {{site.data.keyword.containershort_notm}}의 지역
{: #container_regions}
...
하나의 글로벌 엔드포인트: `https://containers.bluemix.net/v1`을 통해 {{site.data.keyword.containershort_notm}}에 액세스할 수 있습니다. 
* 현재 자신이 위치한 {{site.data.keyword.containershort_notm}} 지역을 확인하려면 `ibmcloud ks region`을 실행하십시오. 
...
{{site.data.keyword.containershort_notm}} CLI를 사용하여 지역을 변경할 수 있습니다.
{:shortdesc}
...
지역을 신속하게 전환하려면 `ibmcloud ks region-set`를 실행하십시오. 
...
## {{site.data.keyword.containershort_notm}}의 구역
{: #zones}
