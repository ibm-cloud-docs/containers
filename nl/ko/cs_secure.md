...
<dl>
  ...
  <dd>개인 정보를 보유하도록 디자인된 Kubernetes 리소스에만 개인 정보를 저장하십시오. 예를 들어, Kubernetes 네임스페이스, 배치, 서비스 또는 구성 맵의 이름에 사용자 이름을 사용하지 마십시오. 적절한 보호 및 암호화를 위해 대신 <a href="cs_encrypt.html#secrets">Kubernetes 시크릿</a>에 개인 정보를 저장하십시오.</dd>
