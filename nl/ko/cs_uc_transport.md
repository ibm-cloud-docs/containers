...
## 운송 회사가 파트너 에코시스템을 위해 전 세계 시스템의 가용성을 향상시킴
{: #uc_shipping}
...
주요 기술:    
* [파트너 에코시스템을 위한 다중 지역](https://console.bluemix.net/docs/containers/cs_regions.html#regions-and-locations)
...
* [앱에 이벤트 데이터를 피드하기 위한 {{site.data.keyword.messagehub_full}}](https://console.bluemix.net/docs/services/MessageHub/messagehub010.html#about)

**컨텍스트: 운송 회사가 파트너 에코시스템을 위해 전 세계 시스템의 가용성을 향상시킴**
...
개발자의 경우 대부분의 Continuous Integration 및 Delivery(CI/CD) 프로세스는 {{site.data.keyword.contdelivery_full}}를 통해 자동화할 수 있습니다. 회사는 컨테이너 이미지를 준비하고, 취약성을 확인하고, 이를 Kubernetes 클러스터에 배치하는 데 사용되는 워크플로우 도구 체인을 정의할 수 있습니다.  
...
항공사는 사람을 우선하는 열린 문화를 설계하고자 합니다. HR 책임자는 재능 있는 직원에게 혜택을 주어 유지하는 것이 항공사의 수익성에 영향을 준다는 점을 잘 알고 있습니다. 따라서 연간 혜택의 공개는 직원 중심의 문화를 배양하는 데 있어서 중요한 요소입니다.  
