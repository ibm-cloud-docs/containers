...
{{site.data.keyword.containerlong_notm}}의 Kubernetes 클러스터에서 앱을 배치할 때 클러스터로서 동일한 사설 네트워크에 있는 사용자 및 서비스만 앱에 액세스할 수 있도록 설정할 수 있습니다. 예를 들어, 앱에 대한 사설 NLB를 작성한다고 가정합니다. 이 사설 NLB는 다음에 의해 액세스될 수 있습니다.
