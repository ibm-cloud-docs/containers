...
1. 클러스터를 프로비저닝하는 데 몇 분이 걸릴 수 있습니다. 시간을 최대한으로 활용하려면 CLI를 설치하기 전에 [클러스터를 작성 ![외부 링크 아이콘](../icons/launch-glyph.svg "외부 링크 아이콘")](https://console.bluemix.net/containers-kubernetes/launch?env_id=ibm:yp:united-kingdom)하십시오.
라이트 클러스터는 컨테이너 포드가 배치될 하나의 작업자 노드와 함께 제공됩니다. 작업자 노드는 앱이 실행되는 컴퓨팅 호스트(일반적으로 가상 머신)입니다. 
