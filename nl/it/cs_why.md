...
| Master altamente disponibili | <ul><li>Riduci i tempi di inattività del cluster, ad esempio durante gli aggiornamenti del master, con i master altamente disponibili che vengono forniti automaticamente quando crei un cluster.</li><li>Estendi i tuoi master tra le zone in un [cluster multizona](/docs/containers?topic=containers-plan_clusters#multizone) per proteggere il tuo cluster in caso di malfunzionamenti della zona.</li></ul> |
