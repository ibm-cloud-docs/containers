...
Se non vuoi spostare le tue applicazioni in {{site.data.keyword.Bluemix_notm}} pubblico o dedicato, ma vuoi comunque sfruttare le funzioni di {{site.data.keyword.containerlong_notm}}, puoi installare {{site.data.keyword.Bluemix_notm}} privato. {{site.data.keyword.Bluemix_notm}} privato è una piattaforma applicativa che può essere installata localmente sulle tue macchine e che puoi utilizzare per sviluppare e gestire applicazioni inserite in un contenitore in loco nel tuo ambiente controllato dietro un firewall. 
