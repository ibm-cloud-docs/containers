...
1. Ottieni gli indirizzi IP su cui sono in ascolto i tuoi ALB pubblici.
    ...
    * Se un ALB pubblico non ha alcun indirizzo IP, vedi [L'ALB Ingress non viene distribuito in una zona](cs_troubleshoot_network.html#cs_multizone_subnet_limit).
