...
Puoi visualizzare, gestire e controllare le attività avviate dall'utente nel tuo cluster OpenShift o Kubernetes della community {{site.data.keyword.containerlong}} utilizzando il servizio {{site.data.keyword.cloudaccesstrailshort}}.
{: shortdesc}
...
<td>Viene annullata l'impostazione delle credenziali dell'infrastruttura in una regione per un gruppo di risorse.</td></tr><tr>
<td><code>containers-kubernetes.alb.create</code></td>
<td>Viene creato un ALB Ingress.</td></tr><tr>
<td><code>containers-kubernetes.alb.delete</code></td>
<td>Viene eliminato un ALB Ingress.</td></tr><tr>
<td><code>containers-kubernetes.alb.get</code></td>
<td>Vengono visualizzate informazioni sull'ALB Ingress.</td></tr><tr>
<td><code>containers-kubernetes.apikey.reset</code></td>
<td>Viene reimpostata una chiave API per una regione e un gruppo di risorse.</td></tr><tr>
<td><code>containers-kubernetes.cluster.create</code></td>
<td>Viene creato un cluster.</td></tr><tr>
<td><code>containers-kubernetes.cluster.delete</code></td>
<td>Viene eliminato un cluster.</td></tr><tr>
<td><code>containers-kubernetes.cluster-feature.enable</code></td>
<td>Una funzione, come un endpoint del servizio pubblico o privato, viene abilitata su un cluster.</td></tr><tr>
...
<td>Viene creata una configurazione di inoltro log.</td></tr><tr>
<td><code>containers-kubernetes.logging-config.delete</code></td>
<td>Viene eliminata una configurazione di inoltro log.</td></tr><tr>
<td><code>containers-kubernetes.logging-config.get</code></td>
<td>Vengono visualizzate informazioni relative a una configurazione di inoltro log.</td></tr><tr>
<td><code>containers-kubernetes.logging-config.update</code></td>
<td>Viene aggiornata una configurazione di inoltro log.</td></tr><tr>
<td><code>containers-kubernetes.logging-config.refresh</code></td>
<td>Viene eseguito un aggiornamento di una configurazione di inoltro log.</td></tr><tr>
<td><code>containers-kubernetes.logging-filter.create</code></td>
<td>Viene creato un filtro di registrazione.</td></tr><tr>
<td><code>containers-kubernetes.logging-filter.delete</code></td>
<td>Viene eliminato un filtro di registrazione.</td></tr><tr>
<td><code>containers-kubernetes.logging-filter.get</code></td>
<td>Vengono visualizzate informazioni relative al filtro di registrazione.</td></tr><tr>
<td><code>containers-kubernetes.logging-filter.update</code></td>
<td>Viene aggiornato un filtro di registrazione.</td></tr><tr>
<td><code>containers-kubernetes.logging-autoupdate.changed</code></td>
<td>Il programma di aggiornamento automatico del componente aggiuntivo di registrazione viene abilitato o disabilitato.</td></tr><tr>
<td><code>containers-kubernetes.mzlb.create</code></td>
<td>Viene creato un programma di bilanciamento del carico multizona.</td></tr><tr>
<td><code>containers-kubernetes.mzlb.delete</code></td>
<td>Viene eliminato un programma di bilanciamento del carico multizona.</td></tr><tr>
<td><code>containers-kubernetes.service.bind</code></td>
<td>Viene eseguito il bind di un servizio a un cluster.</td></tr><tr>
<td><code>containers-kubernetes.service.unbind</code></td>
<td>Viene annullato il bind di un servizio a un cluster.</td></tr><tr>
<td><code>containers-kubernetes.subnet.add</code></td>
<td>Una sottorete dell'infrastruttura IBM Cloud esistente viene aggiunta a un cluster.</td></tr><tr>
<td><code>containers-kubernetes.subnet.create</code></td>
<td>Viene creata una sottorete.</td></tr><tr>
<td><code>containers-kubernetes.usersubnet.add</code></td>
<td>Una sottorete gestita dall'utente viene aggiunta a un cluster.</td></tr><tr>
<td><code>containers-kubernetes.usersubnet.delete</code></td>
<td>Una sottorete gestita dall'utente viene rimossa da un cluster.</td></tr><tr>
<td><code>containers-kubernetes.version.update</code></td>
<td>Viene aggiornata la versione Kubernetes di un nodo master del cluster.</td></tr><tr>
<td><code>containers-kubernetes.worker.create</code></td>
<td>Viene creato un nodo di lavoro.</td></tr><tr>
<td><code>containers-kubernetes.worker.delete</code></td>
<td>Viene eliminato un nodo di lavoro.</td></tr><tr>
<td><code>containers-kubernetes.worker.get</code></td>
<td>Vengono visualizzate informazioni relative a un nodo di lavoro.</td></tr><tr>
<td><code>containers-kubernetes.worker.reboot</code></td>
<td>Viene riavviato un nodo di lavoro.</td></tr><tr>
<td><code>containers-kubernetes.worker.reload</code></td>
<td>Viene ricaricato un nodo di lavoro.</td></tr><tr>
<td><code>containers-kubernetes.worker.update</code></td>
<td>Viene aggiornato un nodo di lavoro.</td></tr>
</table>
...
<table>
    ...
    <td>Viene creato un bind.</td></tr><tr>
    <td><code>certificatesigningrequests.create</code></td>
    <td>Viene creata una richiesta per firmare un certificato.</td></tr><tr>
    <td><code>certificatesigningrequests.delete</code></td>
    <td>Viene eliminata una richiesta per firmare un certificato.</td></tr><tr>
    <td><code>certificatesigningrequests.patch</code></td>
    <td>Viene corretta una richiesta per firmare un certificato.</td></tr><tr>
    <td><code>certificatesigningrequests.update</code></td>
    <td>Viene aggiornata una richiesta per firmare un certificato.</td></tr><tr>
    <td><code>clusterbindings.create</code></td>
    <td>Viene creato un bind del ruolo cluster.</td></tr><tr>
    <td><code>clusterbindings.deleted</code></td>
    <td>Viene eliminato un bind del ruolo cluster.</td></tr><tr>
    <td><code>clusterbindings.patched</code></td>
    <td>Viene corretto un bind del ruolo cluster.</td></tr><tr>
    <td><code>clusterbindings.updated</code></td>
    <td>Viene aggiornato un bind del ruolo cluster.</td></tr><tr>
    <td><code>clusterroles.create</code></td>
    <td>Viene creato un ruolo cluster.</td></tr><tr>
    <td><code>clusterroles.deleted</code></td>
    <td>Viene eliminato un ruolo cluster.</td></tr><tr>
    <td><code>clusterroles.patched</code></td>
    <td>Viene corretto un ruolo cluster.</td></tr><tr>
    <td><code>clusterroles.updated</code></td>
    <td>Viene aggiornato un ruolo cluster.</td></tr><tr>
    <td><code>configmaps.create</code></td>
    <td>Viene creata una mappa di configurazione.</td></tr><tr>
    <td><code>configmaps.delete</code></td>
    <td>Viene eliminata una mappa di configurazione.</td></tr><tr>
    <td><code>configmaps.patch</code></td>
    <td>Viene corretta una mappa di configurazione.</td></tr><tr>
    <td><code>configmaps.update</code></td>
    <td>Viene aggiornata una mappa di configurazione.</td></tr><tr>
    <td><code>controllerrevisions.create</code></td>
    <td>Viene creata una revisione del controller.</td></tr><tr>
    <td><code>controllerrevisions.delete</code></td>
    <td>Viene eliminata una revisione del controller.</td></tr><tr>
    <td><code>controllerrevisions.patch</code></td>
    <td>Viene corretta una revisione del controller.</td></tr><tr>
    <td><code>controllerrevisions.update</code></td>
    <td>Viene aggiornata una revisione del controller.</td></tr><tr>
    <td><code>daemonsets.create</code></td>
    <td>Viene creata una serie di daemon.</td></tr><tr>
    <td><code>daemonsets.delete</code></td>
    <td>Viene eliminata una serie di daemon.</td></tr><tr>
    <td><code>daemonsets.patch</code></td>
    <td>Viene corretta una serie di daemon.</td></tr><tr>
    <td><code>daemonsets.update</code></td>
    <td>Viene aggiornata una serie di daemon.</td></tr><tr>
    <td><code>deployments.create</code></td>
    <td>Viene creata una distribuzione.</td></tr><tr>
    <td><code>deployments.delete</code></td>
    <td>Viene eliminata una distribuzione.</td></tr><tr>
    <td><code>deployments.patch</code></td>
    <td>Viene corretta una distribuzione.</td></tr><tr>
    <td><code>deployments.update</code></td>
    <td>Viene aggiornata una distribuzione.</td></tr><tr>
    <td><code>events.create</code></td>
    <td>Viene creato un evento.</td></tr><tr>
    <td><code>events.delete</code></td>
    <td>Viene eliminato un evento.</td></tr><tr>
    <td><code>events.patch</code></td>
    <td>Viene corretto un evento.</td></tr><tr>
    <td><code>events.update</code></td>
    <td>Viene aggiornato un evento.</td></tr><tr>
    <td><code>externaladmissionhookconfigurations.create</code></td>
    <td>In Kubernetes v1.8, viene creata una configurazione hook di ammissioni esterne.</td></tr><tr>
    <td><code>externaladmissionhookconfigurations.delete</code></td>
    <td>In Kubernetes v1.8, viene eliminata una configurazione hook di ammissioni esterne.</td></tr><tr>
    <td><code>externaladmissionhookconfigurations.patch</code></td>
    <td>In Kubernetes v1.8, viene corretta una configurazione hook di ammissioni esterne.</td></tr><tr>
    <td><code>externaladmissionhookconfigurations.update</code></td>
    <td>In Kubernetes v1.8, viene aggiornata una configurazione hook di ammissioni esterne.</td></tr><tr>
    <td><code>horizontalpodautoscalers.create</code></td>
    <td>Viene creata una politica di ridimensionamento automatico pod orizzontale.</td></tr><tr>
    <td><code>horizontalpodautoscalers.delete</code></td>
    <td>Viene eliminata una politica di ridimensionamento automatico pod orizzontale.</td></tr><tr>
    <td><code>horizontalpodautoscalers.patch</code></td>
    <td>Viene corretta una politica di ridimensionamento automatico pod orizzontale.</td></tr><tr>
    <td><code>horizontalpodautoscalers.update</code></td>
    <td>Viene aggiornata una politica di ridimensionamento automatico pod orizzontale.</td></tr><tr>
    <td><code>ingresses.create</code></td>
    <td>Viene creato un ALB Ingress.</td></tr><tr>
    <td><code>ingresses.delete</code></td>
    <td>Viene eliminato un ALB Ingress.</td></tr><tr>
    <td><code>ingresses.patch</code></td>
    <td>Viene corretto un ALB Ingress.</td></tr><tr>
    <td><code>ingresses.update</code></td>
    <td>Viene aggiornato un ALB Ingress.</td></tr><tr>
    <td><code>jobs.create</code></td>
    <td>Viene creato un lavoro.</td></tr><tr>
    <td><code>jobs.delete</code></td>
    <td>Viene eliminato un lavoro.</td></tr><tr>
    <td><code>jobs.patch</code></td>
    <td>Viene corretto un lavoro.</td></tr><tr>
    <td><code>jobs.update</code></td>
    <td>Viene aggiornato un lavoro.</td></tr><tr>
    <td><code>localsubjectaccessreviews.create</code></td>
    <td>Viene creata una revisione di accesso locale del soggetto.</td></tr><tr>
    <td><code>limitranges.create</code></td>
    <td>Viene creato un limite di intervallo.</td></tr><tr>
    <td><code>limitranges.delete</code></td>
    <td>Viene eliminato un limite di intervallo.</td></tr><tr>
    <td><code>limitranges.patch</code></td>
    <td>Viene corretto un limite di intervallo.</td></tr><tr>
    <td><code>limitranges.update</code></td>
    <td>Viene aggiornato un limite di intervallo.</td></tr><tr>
    ...
    <td>Viene creato uno spazio dei nomi.</td></tr><tr>
    <td><code>namespaces.delete</code></td>
    <td>Viene eliminato uno spazio dei nomi.</td></tr><tr>
    <td><code>namespaces.patch</code></td>
    <td>Viene corretto uno spazio dei nomi.</td></tr><tr>
    <td><code>namespaces.update</code></td>
    <td>Viene aggiornato uno spazio dei nomi.</td></tr><tr>
    <td><code>networkpolicies.create</code></td>
    <td>Viene creata una politica di rete.</td></tr><tr><tr>
    <td><code>networkpolicies.delete</code></td>
    <td>Viene eliminata una politica di rete.</td></tr><tr>
    <td><code>networkpolicies.patch</code></td>
    <td>Viene corretta una politica di rete.</td></tr><tr>
    <td><code>networkpolicies.update</code></td>
    <td>Viene aggiornata una politica di rete.</td></tr><tr>
    <td><code>nodes.create</code></td>
    <td>Viene creato un nodo.</td></tr><tr>
    <td><code>nodes.delete</code></td>
    <td>Viene eliminato un nodo.</td></tr><tr>
    <td><code>nodes.patch</code></td>
    <td>Viene corretto un nodo.</td></tr><tr>
    <td><code>nodes.update</code></td>
    <td>Viene aggiornato un nodo.</td></tr><tr>
    <td><code>persistentvolumeclaims.create</code></td>
    <td>Viene creata un'attestazione del volume persistente.</td></tr><tr>
    <td><code>persistentvolumeclaims.delete</code></td>
    <td>Viene eliminata un'attestazione del volume persistente.</td></tr><tr>
    <td><code>persistentvolumeclaims.patch</code></td>
    <td>Viene corretta un'attestazione del volume persistente.</td></tr><tr>
    <td><code>persistentvolumeclaims.update</code></td>
    <td>Viene aggiornata un'attestazione del volume persistente.</td></tr><tr>
    <td><code>persistentvolumes.create</code></td>
    <td>Viene creato un volume persistente.</td></tr><tr>
    <td><code>persistentvolumes.delete</code></td>
    <td>Viene eliminato un volume persistente.</td></tr><tr>
    <td><code>persistentvolumes.patch</code></td>
    <td>Viene corretto un volume persistente.</td></tr><tr>
    <td><code>persistentvolumes.update</code></td>
    <td>Viene aggiornato un volume persistente.</td></tr><tr>
    <td><code>poddisruptionbudgets.create</code></td>
    <td>Viene creato un PDB (Pod Disruption Budget).</td></tr><tr>
    <td><code>poddisruptionbudgets.delete</code></td>
    <td>Viene eliminato un PDB (Pod Disruption Budget).</td></tr><tr>
    <td><code>poddisruptionbudgets.patch</code></td>
    <td>Viene corretto un PDB (Pod Disruption Budget).</td></tr><tr>
    <td><code>poddisruptionbudgets.update</code></td>
    <td>Viene aggiornato un PDB (Pod Disruption Budget).</td></tr><tr>
    <td><code>podpresets.create</code></td>
    <td>Viene creato un pod preimpostato.</td></tr><tr>
    <td><code>podpresets.deleted</code></td>
    <td>Viene eliminato un pod preimpostato.</td></tr><tr>
    <td><code>podpresets.patched</code></td>
    <td>Viene corretto un pod preimpostato.</td></tr><tr>
    <td><code>podpresets.updated</code></td>
    <td>Viene aggiornato un pod preimpostato.</td></tr><tr>
    <td><code>pods.create</code></td>
    <td>Viene creato un pod.</td></tr><tr>
    <td><code>pods.delete</code></td>
    <td>Viene eliminato un pod.</td></tr><tr>
    <td><code>pods.patch</code></td>
    <td>Viene corretto un pod.</td></tr><tr>
    <td><code>pods.update</code></td>
    <td>Viene aggiornato un pod.</td></tr><tr>
    <td><code>podsecuritypolicies.create</code></td>
    <td>Viene creata una politica di sicurezza dei pod.</td></tr><tr>
    <td><code>podsecuritypolicies.delete</code></td>
    <td>Viene eliminata una politica di sicurezza dei pod.</td></tr><tr>
    <td><code>podsecuritypolicies.patch</code></td>
    <td>Viene corretta una politica di sicurezza dei pod.</td></tr><tr>
    <td><code>podsecuritypolicies.update</code></td>
    <td>Viene aggiornata una politica di sicurezza dei pod.</td></tr><tr>
    <td><code>podtemplates.create</code></td>
    <td>Viene creato un template di pod.</td></tr><tr>
    <td><code>podtemplates.delete</code></td>
    <td>Viene eliminato un template di pod.</td></tr><tr>
    <td><code>podtemplates.patch</code></td>
    <td>Viene corretto un template di pod.</td></tr><tr>
    <td><code>podtemplates.update</code></td>
    <td>Viene aggiornato un template di pod.</td></tr><tr>
    <td><code>replicasets.create</code></td>
    <td>Viene creata una serie di repliche.</td></tr><tr>
    <td><code>replicasets.delete</code></td>
    <td>Viene eliminata una serie di repliche.</td></tr><tr>
    <td><code>replicasets.patch</code></td>
    <td>Viene corretta una serie di repliche.</td></tr><tr>
    <td><code>replicasets.update</code></td>
    <td>Viene aggiornata una serie di repliche.</td></tr><tr>
    <td><code>replicationcontrollers.create</code></td>
    <td>Viene creato un controller di replica.</td></tr><tr>
    <td><code>replicationcontrollers.delete</code></td>
    <td>Viene eliminato un controller di replica.</td></tr><tr>
    <td><code>replicationcontrollers.patch</code></td>
    <td>Viene corretto un controller di replica.</td></tr><tr>
    <td><code>replicationcontrollers.update</code></td>
    <td>Viene aggiornato un controller di replica.</td></tr><tr>
    <td><code>resourcequotas.create</code></td>
    <td>Viene creata una quota della risorsa.</td></tr><tr>
    <td><code>resourcequotas.delete</code></td>
    <td>Viene eliminata una quota della risorsa.</td></tr><tr>
    <td><code>resourcequotas.patch</code></td>
    <td>Viene corretta una quota della risorsa.</td></tr><tr>
    <td><code>resourcequotas.update</code></td>
    <td>Viene aggiornata una quota della risorsa.</td></tr><tr>
    <td><code>rolebindings.create</code></td>
    <td>Viene creato un bind del ruolo.</td></tr><tr>
    <td><code>rolebindings.deleted</code></td>
    <td>Viene eliminato un bind del ruolo.</td></tr><tr>
    <td><code>rolebindings.patched</code></td>
    <td>Viene corretto un bind del ruolo.</td></tr><tr>
    <td><code>rolebindings.updated</code></td>
    <td>Viene aggiornato un bind del ruolo.</td></tr><tr>
    <td><code>roles.create</code></td>
    <td>Viene creato un ruolo.</td></tr><tr>
    <td><code>roles.deleted</code></td>
    <td>Viene eliminato un ruolo.</td></tr><tr>
    <td><code>roles.patched</code></td>
    <td>Viene corretto un ruolo.</td></tr><tr>
    <td><code>roles.updated</code></td>
    <td>Viene aggiornato un ruolo.</td></tr><tr>
    <td><code>secrets.create</code></td>
    <td>Viene creato un segreto.</td></tr><tr>
    <td><code>secrets.deleted</code></td>
    <td>Viene eliminato un segreto.</td></tr><tr>
    <td><code>secrets.get</code></td>
    <td>Viene visualizzato un segreto.</td></tr><tr>
    <td><code>secrets.patch</code></td>
    <td>Viene corretto un segreto.</td></tr><tr>
    <td><code>secrets.updated</code></td>
    <td>Viene aggiornato un segreto.</td></tr><tr>
    <td><code>selfsubjectaccessreviews.create</code></td>
    <td>Viene creata una revisione dell'accesso del soggetto autonomo.</td></tr><tr>
    <td><code>selfsubjectrulesreviews.create</code></td>
    <td>Viene creata una revisione delle regole del soggetto autonomo.</td></tr><tr>
    <td><code>subjectaccessreviews.create</code></td>
    <td>Viene creata una revisione dell'accesso del soggetto.</td></tr><tr>
    <td><code>serviceaccounts.create</code></td>
    <td>Viene creato un account di servizio.</td></tr><tr>
    <td><code>serviceaccounts.deleted</code></td>
    <td>Viene eliminato un account di servizio.</td></tr><tr>
    <td><code>serviceaccounts.patch</code></td>
    <td>Viene corretto un account di servizio.</td></tr><tr>
    <td><code>serviceaccounts.updated</code></td>
    <td>Viene aggiornato un account di servizio.</td></tr><tr>
    <td><code>services.create</code></td>
    <td>Viene creato un servizio.</td></tr><tr>
    <td><code>services.deleted</code></td>
    <td>Viene eliminato un servizio.</td></tr><tr>
    <td><code>services.patch</code></td>
    <td>Viene corretto un servizio.</td></tr><tr>
    <td><code>services.updated</code></td>
    <td>Viene aggiornato un servizio.</td></tr><tr>
    <td><code>statefulsets.create</code></td>
    <td>Viene creata una serie con stato.</td></tr><tr>
    <td><code>statefulsets.delete</code></td>
    <td>Viene eliminata una serie con stato.</td></tr><tr>
    <td><code>statefulsets.patch</code></td>
    <td>Viene corretta una serie con stato.</td></tr><tr>
    <td><code>statefulsets.update</code></td>
    <td>Viene aggiornata una serie con stato.</td></tr><tr>
    <td><code>tokenreviews.create</code></td>
    <td>Viene creata una revisione token.</td></tr><tr>
