...
Rendere disponibile una sottorete in un account {{site.data.keyword.BluSoftlayer_notm}}
per un cluster specificato.
...
Impostare le credenziali dell'account {{site.data.keyword.BluSoftlayer_notm}} per il tuo
...
Rimuovere le credenziali dell'account {{site.data.keyword.BluSoftlayer_notm}}
dal tuo account {{site.data.keyword.Bluemix_notm}}. Una volta rimosse
...
|-------------|------|
|Distribuzione|Il master Kubernetes non è ancora stato completamente distribuito. Non puoi accedere al cluster.|
