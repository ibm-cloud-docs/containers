...
* [Fornisci l'accesso ai dati pubblici con {{site.data.keyword.cos_full_notm}}](https://console.bluemix.net/docs/services/cloud-object-storage/about-cos.html#about-ibm-cloud-object-storage)
...
* Le collaborazioni tra pubblico e privato conquistano compiti erculei, come il rilevamento dei virus Zika, la distribuzione intelligente dell'elettricità, l'analisi delle statistiche sulla criminalità e l'istruzione universitaria per le nuove professionalità (new collar).

## Il grande porto pubblico protegge lo scambio di dati portuali e manifesti di carico che collegano organizzazioni pubbliche e private
{: #uc_port}
...
**Risultati**
* Con i kit starter IBM, {{site.data.keyword.containerlong_notm}} e gli strumenti {{site.data.keyword.contdelivery_full}}, gli sviluppatori globali collaborano con organizzazioni e governi. Sviluppano collaborativamente applicazioni doganali, con strumenti familiari e interoperabili. 
