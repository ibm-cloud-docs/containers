...
## La società di spedizione aumenta la disponibilità dei sistemi mondiali per l'ecosistema di partner
{: #uc_shipping}
...
* [{{site.data.keyword.messagehub_full}} per inserire dati di evento nelle applicazioni](https://console.bluemix.net/docs/services/MessageHub/messagehub010.html#about)

**Contesto: la società di spedizione aumenta la disponibilità dei sistemi mondiali per l'ecosistema di partner**
