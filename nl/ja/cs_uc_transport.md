...
## 輸送会社によるパートナー・エコシステム用の世界規模のシステム可用性の向上
{: #uc_shipping}
...
主要なテクノロジー:    
* [パートナー・エコシステムのための複数の地域](https://console.bluemix.net/docs/containers/cs_regions.html#regions-and-locations)
...
* [アプリにイベント・データをフィードするための {{site.data.keyword.messagehub_full}}](https://console.bluemix.net/docs/services/MessageHub/messagehub010.html#about)

**コンテキスト: 輸送会社によるパートナー・エコシステム用の世界規模のシステム可用性の向上**
...
航空会社は、従業員を最優先にしたオープンな社風を作ろうとしています。HR 幹部は、人材にインセンティブを提示して維持することに重点を置くと、この航空会社の収益性に影響するということをよく認識しています。したがって、福利厚生の年に一度のロールアウトは、従業員を中心に考える社風を育てるうえで重要な側面です。 
