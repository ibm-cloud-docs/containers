...
<dl>
  <dt>ワーカー・ノードの所有権</dt>
    <dd>ワーカー・ノードの所有権は、作成するクラスターのタイプによって異なります。<p> フリー・クラスター内のワーカー・ノードは、IBM の所有する IBM Cloud インフラストラクチャー (SoftLayer) アカウントにプロビジョンされます。このようなワーカー・ノードには、アプリをデプロイすることはできますが、設定の変更、ワーカー・ノードへの追加のソフトウェアのインストールを行うことはできません。</p> <p>標準クラスター内のワーカー・ノードは、お客様の IBM Cloud パブリック・アカウントまたは専用アカウントに関連付けられている IBM Cloud インフラストラクチャー (SoftLayer) アカウントにプロビジョンされます。ワーカー・ノードはお客様が所有しますが、オペレーティング・システムに更新プログラムやセキュリティー・パッチをデプロイするために、IBM はワーカー・ノードへのアクセスを維持しています。お客様はセキュリティー設定を変更したり、ワーカー・ノードに IBM Cloud Container Service が提供する追加のソフトウェアをインストールしたりできます。</p> </dd>
