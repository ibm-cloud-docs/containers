...
[開始する前に、フリー・クラスターを作成するための従量課金 (PAYG) またはサブスクリプション {{site.data.keyword.Bluemix_notm}} アカウントが必要です。](https://console.bluemix.net/registration/)
...
2.  **クラスター名**を入力します。 デフォルトのクラスター・タイプはフリーです。 次は、標準クラスターを作成し、クラスター内のワーカー・ノード数などの追加のカスタマイズを定義できます。
...
*   フリー・クラスターでは、CPU 2 つとメモリー 4 GB を備えたワーカー・ノード 1 つを、アプリで使用できます。
