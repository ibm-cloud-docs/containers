...
以下の情報を参照してください。
- ボリューム単位の暗号化のための {{site.data.keyword.keymanagementservicelong_notm}} を使用した [Portworx ボリューム暗号化ワークフロー](#encryption)
