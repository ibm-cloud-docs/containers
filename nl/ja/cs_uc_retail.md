...
小売業者がグローバル・パートナーと連携するために、在庫 API にはそれぞれの地域の言語や市場の選好に適合するための変更が必要でした。 {{site.data.keyword.containerlong_notm}} は、北アメリカ、ヨーロッパ、アジア、オーストラリアを含む複数の地域を対象としているため、API には各国のニーズが反映され、API 呼び出しについて低遅延が保証されていました。
