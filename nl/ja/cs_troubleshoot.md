...
- [ワーカー・ノードを更新するための](cs_cli_reference.html#cs_worker_update)セキュリティー・パッチやオペレーティング・システム・パッチが利用可能になっていないか、毎月確認してください。
