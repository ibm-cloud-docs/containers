...
**Supported infrastructure provider**: ![VPC infrastructure provider icon.](images/icon-vpc-2.png) VPC
...
**Supported infrastructure provider**: ![Classic infrastructure provider icon.](images/icon-classic-2.png) Classic. To create a VPC cluster, use the [`ibmcloud ks cluster create vpc-gen2` command](#cli_cluster-create-vpc-gen2) instead.
...
**Supported infrastructure provider**: ![Classic infrastructure provider icon.](images/icon-classic-2.png) Classic. The private cloud service endpoint is permanently enabled by default for VPC clusters.
...
**Supported infrastructure provider**: ![Classic infrastructure provider icon.](images/icon-classic-2.png) Classic
...
**Supported infrastructure provider**: ![Classic infrastructure provider icon.](images/icon-classic-2.png) Classic. To reload a worker node in a VPC cluster, use the [`ibmcloud ks worker replace` command](#cli_worker_replace) instead.
...
**Supported infrastructure provider**: ![Classic infrastructure provider icon.](images/icon-classic-2.png) Classic. To update a worker node in a VPC cluster, use the [`ibmcloud ks worker replace` command](#cli_worker_replace) instead.
...
**Supported infrastructure provider**: ![Classic infrastructure provider icon.](images/icon-classic-2.png) Classic. To create a worker pool in a VPC cluster, use the [`ibmcloud ks worker-pool create vpc-gen2` command](#cli_worker_pool_create_vpc_gen2).
...
**Supported infrastructure provider**: ![Classic infrastructure provider icon.](images/icon-classic-2.png) Classic. To add a zone to worker pools in a VPC cluster, use the [`ibmcloud ks zone add vpc-gen2` command](#cli_zone-add-vpc-gen2).
...
![Classic infrastructure provider icon.](images/icon-classic-2.png) ![VPC infrastructure provider icon.](images/icon-vpc-2.png) This command works for both classic and VPC clusters.
...
![Classic infrastructure provider icon.](images/icon-classic-2.png) You can manually set infrastructure credentials to a different account only for classic clusters, not for VPC clusters.
...
![Classic infrastructure provider icon.](images/icon-classic-2.png) This group of commands is for classic clusters only.
