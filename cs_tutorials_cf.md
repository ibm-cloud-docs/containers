...
Want to automatically generate a Dockerfile and Kubernetes configuration files for your application? Try using a migration tool like [Konveyor Move2Kube](https://konveyor.io/move2kube/){: external} along with the steps in this tutorial.
{: tip}
...
3. Now that all the deployment work is done, you can test your app in a browser. Get the details to form the URL.
    ...
    kube-dal10-cr18e61e63c6e94b658596ca93d087eed9-w1   169.xx.xxx.xxx   10.xxx.xx.xxx   u3c.2x4.encrypted   normal   Ready    dal10   1.18.15
    ```
    {: screen}
