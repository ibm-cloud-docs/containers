...
# Version 1.13 change log (unsupported 22 February 2020)
{: #113_changelog}


Version 1.13 is unsupported. You can review the following archive of 1.13 change logs.
{: shortdesc}
...
| Component | Previous | Current | Description |
| -------------- | -------------- | -------------- | ------------- |
| Calico | v3.4.4 | v3.6.4 | See the [Calico release notes](https://docs.tigera.io/calico/3.25/release-notes/){: external}. Update resolves [TTA-2019-001](https://www.tigera.io/security-bulletins/#TTA-2019-001){: external}. For more information, see the [IBM security bulletin](https://www.ibm.com/support/pages/node/959551){: external}. |
...
| Component | Previous | Current | Description |
| -------------- | -------------- | -------------- | ------------- |
| Calico | v3.3.1 | v3.4.0 | See the [Calico release notes](https://docs.tigera.io/calico/3.25/release-notes/){: external}. |
