...
1. Describe your volume snapshot and review the status.
    ...
    * If there is a `shares_access_forbidden` error, make sure that you have **Share Snapshot Operator** [permissions in IAM](/docs/iam?topic=iam-iam-service-roles-actions#is.share-roles).
