...
Portworx is available for standard clusters that are set up with public network connectivity. If your cluster cannot access the public network, such as a private cluster behind a firewall, you cannot use Portworx in your cluster, unless you open up all egress network traffic on TCP port 443.
