...
6. [Retrieve the {{site.data.keyword.keymanagementservicelong_notm}} API endpoint](/docs/services/key-protect/regions.html#regions) for the region where you created your service instance.
