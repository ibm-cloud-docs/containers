...
```sh
ibmcloud ks cluster create vpc-gen2 --name my_cluster --version 1.28_openshift --zone us-east-1 --vpc-id VPC-ID --subnet-id VPC-SUBNET-ID --flavor bx2.4x16 --workers 3  -pod-subnet 172.17.0.0/15
```
{: pre}
