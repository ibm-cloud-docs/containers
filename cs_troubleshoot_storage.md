...
<ff-roks311-vpc>1. Verify that you selected a classic {{site.data.keyword.containerlong_notm}} cluster. VPC on Classic clusters are not supported in Portworx.</ff-roks311-vpc>
