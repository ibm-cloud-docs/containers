...
6. Complete the **Reservation details**. For more information about the discounts, see [Billing and discounts](#ri-about-billing).
...
4. Click **Add+**.
5. Enter the worker pool details.
