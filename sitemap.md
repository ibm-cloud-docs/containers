...
* [`zone` commands](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#zone)
  ...
  * [`ibmcloud ks zone add vpc-classic`](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#cli_zone-add-vpc-classic)
...
* [`ingress` commands](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#alb-commands)
  ...
  * [`ibmcloud ks ingress alb create vpc-classic`](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#cli_alb-create-vpc-classic)
  ...
  * [`ibmcloud ks ingress alb enable vpc-classic`](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#cli_alb_configure_vpc_classic)
...
* [`nlb-dns` commands](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#nlb-dns)
  ...
  * [`ibmcloud ks nlb-dns create vpc-classic`](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#cs_nlb-dns-create-vpc)
  ...
  * [`ibmcloud ks nlb-dns rm vpc-classic`](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#cs_nlb-dns-rm-vpc)
