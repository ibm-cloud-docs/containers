...
* [Adding {{site.data.keyword.appid_short_notm}} authentication to apps](/docs/containers?topic=containers-ingress-settings#app-id)
  * [Adding {{site.data.keyword.appid_short_notm}} for ALBs that run the {{site.data.keyword.containerlong_notm}} Ingress image](/docs/containers?topic=containers-ingress-settings#app-id-iks)
  * [Adding {{site.data.keyword.appid_short_notm}} for ALBs that run the community Kubernetes Ingress image](/docs/containers?topic=containers-ingress-settings#app-id-kube)
