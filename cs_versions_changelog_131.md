...
| Kubernetes Metrics Server | v0.7.1 | v0.7.2 | See the [Kubernetes Metrics Server release notes](h[ttps://github.com/kubernetes-incubator/metrics-server/releases/tag/v0.7.2](https://github.com/kubernetes-sigs/metrics-server/releases/tag/v0.7.2)){: external}. |
