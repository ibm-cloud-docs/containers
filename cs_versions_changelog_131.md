...
### Worker node fix pack 1.31.14_1592, released 27 January 2026
{: #cl-boms-13114_1592_W}

The following table shows the components included in the worker node fix pack 1.31.14_1592. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: caption="1.31.14_1592 fix pack." caption-side="bottom"}
{: #cl-boms-13114_1592_W-component-table}
...
{: #cl-boms-13114_1585_W}

The following table shows the components included in the worker node fix pack 1.31.14_1585. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: caption="1.31.14_1585 fix pack." caption-side="bottom"}
{: #cl-boms-13114_1585_W-component-table}


### Worker node fix pack 1.31.14_1584, released 29 December 2025
{: #cl-boms-13114_1584_W}

The following table shows the components included in the worker node fix pack 1.31.14_1584. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|GPU Device Plug-in and Installer|0057dcb30bc3a8446f9a4eeef56228e56e935b66|Resolves the following CVEs: [CVE-2024-5642](https://nvd.nist.gov/vuln/detail/CVE-2024-5642){: external}, [CVE-2025-6075](https://nvd.nist.gov/vuln/detail/CVE-2025-6075){: external}, [CVE-2025-8291](https://nvd.nist.gov/vuln/detail/CVE-2025-8291){: external}, and [CVE-2025-6069](https://nvd.nist.gov/vuln/detail/CVE-2025-6069){: external}.|
{: caption="1.31.14_1584 fix pack." caption-side="bottom"}
{: #cl-boms-13114_1584_W-component-table}


### Worker node fix pack 1.31.14_1583, released 16 December 2025
{: #cl-boms-13114_1583_W}

The following table shows the components included in the worker node fix pack 1.31.14_1583. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: caption="1.31.14_1583 fix pack." caption-side="bottom"}
...
| {{site.data.keyword.cloud_notm}} Controller Manager | v1.31.13-1 | v1.31.14-2 | New version contains updates and security fixes. |
| Key Management Service provider | v2.10.17 | 2.10.19 | New version contains updates and security fixes. |
| Konnectivity agent and server | v0.31.3 | v0.31.4 | See the [Konnectivity release notes](https://github.com/kubernetes-sigs/apiserver-network-proxy/releases/tag/v0.31.4){: external}. |
| Kubernetes | v1.31.13 | v1.31.14 | See the [Kubernetes release notes](https://github.com/kubernetes/kubernetes/releases/tag/v1.31.14){: external}. |
...
{: caption="Changes since version 1.31.13-1578" caption-side="bottom"}


### Worker node fix pack 1.31.13_1580, released 03 December 2025
{: #cl-boms-13113_1580_W}

The following table shows the components included in the worker node fix pack 1.31.13_1580. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: caption="1.31.13_1580 fix pack." caption-side="bottom"}
{: #cl-boms-13113_1580_W-component-table}
