...
| Konnectivity agent and server | v0.31.3 | v0.31.4 | See the [Konnectivity release notes](https://github.ibm.com/alchemy-containers/armada-konnectivity-community-build/releases/tag/v0.31.4){: external}. |
