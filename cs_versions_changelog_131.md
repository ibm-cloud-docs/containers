...
| Kubernetes | v1.31.11 | v1.31.12 | See the [Kubernetes release notes](https://github.com/kubernetes/kubernetes/releases/tag/v1.31.12){: external} and the [Security Bulletin](https://www.ibm.com/support/pages/node/7245968){: external}. |
