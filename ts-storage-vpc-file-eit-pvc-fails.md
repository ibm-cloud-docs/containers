...
PVC creation fails with an error message similar to the following example.
{: tsSymptoms}


Troubleshoot VPC file storage persistent volume claim failures with EIT (Encrypted In Transit).
{: shortdesc}
