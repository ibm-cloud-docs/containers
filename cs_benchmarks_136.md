...
{: #1-master-node-security-configuration-136}

### 1.1 Master node configuration files
{: #11-master-node-configuration-files-136}
...
{: #4-worker-node-security-configuration-136}
...
| 1.2.11 | {{site.data.keyword.IBM_notm}} does not enable the [_AlwaysPullImages_](https://kubernetes.io/docs/reference/access-authn-authz/admission-controllers/#alwayspullimages){: external} admission controller since it overrides a container's `imagePullPolicy` and may impact performance. |
