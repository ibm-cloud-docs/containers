...
| Kubernetes | v1.32.7 | v1.32.8 | See the [Kubernetes release notes](https://github.com/kubernetes/kubernetes/releases/tag/v1.32.8){: external} and the [Security Bulletin](https://www.ibm.com/support/pages/node/7245968){: external}. |
