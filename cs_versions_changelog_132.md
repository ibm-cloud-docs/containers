...
| etcd | v3.5.22 | v3.5.25 | See the [etcd release notes](https://github.com/coreos/etcd/releases/v3.5.25){: external}. |
...
| Konnectivity agent and server | v0.32.0 | v0.32.1 | See the [Konnectivity release notes](https://github.ibm.com/alchemy-containers/armada-konnectivity-community-build/releases/tag/v0.32.1){: external}. |
