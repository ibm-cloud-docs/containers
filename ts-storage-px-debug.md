...
2. If you want to use a virtual machine cluster, make sure that you [added raw, unformatted, and unmounted block storage](/docs/containers?topic=containers-portworx/docs/containers?topic=containers-utilities#manual_block) to your cluster so that Portworx can include the disks into the Portworx storage layer.
