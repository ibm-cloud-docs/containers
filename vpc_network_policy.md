...
2. List the worker nodes in your cluster. Note the ID of one worker node in each zone of your cluster.
  ...
  kube-bl25g33d0if1cmfn0p8g-vpctest-default-000005ac   10.240.64.10   c2.2x4   normal   Ready    us-south-2   1.17.5
  kube-bl25g33d0if1cmfn0p8g-vpctest-default-00000623   10.240.0.5     c2.2x4   normal   Ready    us-south-1   1.17.5
  ```
  {: screen}
