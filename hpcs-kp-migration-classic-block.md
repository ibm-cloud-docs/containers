...
Before you begin, verify that you need to migrate your Classic Block Storage volumes to use Key Protect instead of HPCS. You can complete this process manually by following the steps in this section, or you can see the [migration overview](/docs/containers?topic=containers-migrate_hpcs_kp) for details on using an automated detection script.
