...
2. Download the Kubernetes CLI `major.minor` version that matches the Kubernetes cluster `major.minor` version that you plan to use. The current {{site.data.keyword.containerlong_notm}} default Kubernetes version is {[kubeversions]}.
    -   **OS X**: [https://storage.googleapis.com/kubernetes-release/release/v{[kubeversions]}/bin/darwin/amd64/kubectl](https://storage.googleapis.com/kubernetes-release/release/v{[kubeversions]}/bin/darwin/amd64/kubectl){: external}
    -   **Linux**: [https://storage.googleapis.com/kubernetes-release/release/v{[kubeversions]}/bin/linux/amd64/kubectl](https://storage.googleapis.com/kubernetes-release/release/v{[kubeversions]}/bin/linux/amd64/kubectl){: external}
    -   **Windows**: Install the Kubernetes CLI in the same directory as the {{site.data.keyword.cloud_notm}} CLI. This setup saves you some file path changes when you run commands later. [https://storage.googleapis.com/kubernetes-release/release/v{[kubeversions]}/bin/windows/amd64/kubectl.exe](https://storage.googleapis.com/kubernetes-release/release/v{[kubeversions]}/bin/windows/amd64/kubectl.exe){: external}
