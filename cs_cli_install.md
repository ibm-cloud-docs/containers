...
-   [`ibmcloud` commands](/docs/cli/reference/bluemix_cli/bx_cli.html)
...
-   {{site.data.keyword.Bluemix_notm}} CLI version 0.5.0 or later
-   {{site.data.keyword.containershort_notm}} plug-in
-   Kubernetes CLI version 1.9.9 or later
