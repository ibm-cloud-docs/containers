...
![Classic infrastructure provider icon.](images/icon-classic-2.svg) Create a network load balancer (NLB) to expose your custom Ingress controller deployment, and then create a hostname for the NLB IP address.
{: shortdesc}
