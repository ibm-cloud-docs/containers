...
Before you begin, [set up a {{site.data.keyword.Bluemix_notm}} Dedicated environment](/docs/dedicated/index.html#setupdedicated).

To set up your Dedicated environment to use clusters:

1.  Add the provided IBM administrator ID to the environment.
    1.  Select your {{site.data.keyword.Bluemix_notm}} Dedicated account.
