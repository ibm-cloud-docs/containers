...
### Worker node fix pack 1.30.14_1593, released 17 November 2025
{: #cl-boms-13014_1593_W}

The following table shows the components included in the worker node fix pack 1.30.14_1593. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: caption="1.30.14_1593 fix pack." caption-side="bottom"}
...
The following table shows the components included in the worker node fix pack 1.30.14_1592. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: #cl-boms-13014_1591_W}

The following table shows the components included in the worker node fix pack 1.30.14_1591. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: caption="1.30.14_1591 fix pack." caption-side="bottom"}
...
The following table shows the components included in the worker node fix pack 1.30.14_1590. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: #cl-boms-13014_1585_W}

The following table shows the components included in the worker node fix pack 1.30.14_1585. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
|HAProxy|e0a48fcf355d98dc769ea048d2fd02044b11ed62|N/A|
|GPU Device Plug-in and Installer|45bd1f84378a5eb92041b5102ef21a5cfe8b36d5|N/A|
{: caption="1.30.14_1585 fix pack." caption-side="bottom"}
...
{: #cl-boms-13014_1581_W}

The following table shows the components included in the worker node fix pack 1.30.14_1581. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: caption="1.30.14_1581 fix pack." caption-side="bottom"}
...
| {{site.data.keyword.cloud_notm}} Controller Manager | v1.30.14-4 | v1.30.14-7 | New version contains updates and security fixes. |
...
{: #cl-boms-13014_1576_W}

The following table shows the components included in the worker node fix pack 1.30.14_1576. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: caption="1.30.14_1576 fix pack." caption-side="bottom"}
...
| Kubernetes | v1.30.13 | v1.30.14 | See the [Kubernetes release notes](https://github.com/kubernetes/kubernetes/releases/tag/v1.30.14){: external}. |
...
The following table shows the components included in the worker node fix pack 1.30.14_1575. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: #cl-boms-13013_1573_W}

The following table shows the components included in the worker node fix pack 1.30.13_1573. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: caption="1.30.13_1573 fix pack." caption-side="bottom"}
...
The following table shows the components included in the worker node fix pack 1.30.13_1572. Worker node patch updates can be applied by updating, reloading (in classic infrastructure), or replacing (in VPC infrastructure) the worker node.
{: shortdesc}
...
{: caption="1.30.13_1572 fix pack." caption-side="bottom"}
...
| Component | Previous | Current | Description |
| --- | --- | --- | --- |
| Calico | v3.27.4 | v3.28.2 | See the [Calico release notes](https://archive-os-3-28.netlify.app/calico/3.28/release-notes/#v3.28.2){: external}. |
...
| Kubernetes configurations | N/A | N/A | See [Default service settings for Kubernetes components](/docs/containers?topic=containers-service-settings). |
