...
| Section | Recommendation | Scored/Not Scored | Level | Result | Responsibility |
| --- | --- | --- | --- | --- | --- |
| 1.2.1 | Ensure that the `--anonymous-auth` option is set to `false`. | Not Scored | 1 | [Fail](#cis-benchmark-remediations-122) | {{site.data.keyword.IBM_notm}} |
...
| 1.2.22 | Ensure that the `--audit-log-path` option is set. | Scored | 1 | [Fail](#cis-benchmark-remediations-122) | Shared |
| 1.2.23 | Ensure that the `--audit-log-maxage` option is set to `30` or as appropriate. | Scored | 1 | [Fail](#cis-benchmark-remediations-122) | Shared |
| 1.2.24 | Ensure that the `--audit-log-maxbackup` option is set to `10` or as appropriate. | Scored | 1 | [Fail](#cis-benchmark-remediations-122) | Shared |
| 1.2.25 | Ensure that the `--audit-log-maxsize` option is set to `100` or as appropriate. | Scored | 1 | [Fail](#cis-benchmark-remediations-122) | Shared |
...
| 4.2.6 | Ensure that the `--protect-kernel-defaults` option is set to `true`. | Scored | 1 | [Fail](#cis-benchmark-remediations-122) | {{site.data.keyword.IBM_notm}} |
| 4.2.7 | Ensure that the `--make-iptables-util-chains` option is set to `true`. | Scored | 1 | Pass | {{site.data.keyword.IBM_notm}} |
| 4.2.8 | Ensure that the `--hostname-override` option is not set. | Not Scored | 1 | [Fail](#cis-benchmark-remediations-122) | {{site.data.keyword.IBM_notm}} |
...
| 5.2.1 | {{site.data.keyword.containerlong_notm}} can optionally configure pod security policies. |
| 5.2.2 | {{site.data.keyword.containerlong_notm}} can optionally configure pod security policies. |
| 5.2.3 | {{site.data.keyword.containerlong_notm}} can optionally configure pod security policies. |
| 5.2.4 | {{site.data.keyword.containerlong_notm}} can optionally configure pod security policies. |
| 5.2.5 | {{site.data.keyword.containerlong_notm}} can optionally configure pod security policies. |
| 5.2.6 | {{site.data.keyword.containerlong_notm}} can optionally configure pod security policies. |
| 5.2.7 | {{site.data.keyword.containerlong_notm}} can optionally configure pod security policies. |
| 5.2.8 | {{site.data.keyword.containerlong_notm}} can optionally configure pod security policies. |
| 5.2.9 | {{site.data.keyword.containerlong_notm}} can optionally configure pod security policies. |
