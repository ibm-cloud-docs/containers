...
Choose one of the following private cluster setups to create a private cluster:
...
### Creating Calico-protected VRF clusters
{: #calico-pc-cluster}
...
### Creating private cluster with a gateway devices
{: #legacy-pc-cluster}
...
Additional network configuration steps for Calico-protected VRF clusters:
...
Additional network configuration steps for private VRF clusters:
* TBD

Additional network configuration steps for private clusters with gateway devices:
