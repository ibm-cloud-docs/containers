...
5.  Verify that the creation of the cluster was requested.
    ...
    * If you see the following error message, [open a support case](/docs/get-support?topic=get-support-getting-customer-support).
    ...
    my_cluster   paf97e8843e29941b49c598f516de72101   deployed   20170201162433   1          mil01     1.14.7      Default
    ```
    {: screen}
...
6.  Check the status of the worker nodes.
    ...
    kube-mil01-paf97e8843e29941b49c598f516de72101-w1   169.xx.xxx.xxx  10.xxx.xx.xxx    free           normal   Ready    mil01      1.14.7
    ```
    {: screen}
