...
2. If your secret does not show `ibm/ibmc-s3fs` as the **Type**, [re-create your secret](https://cloud.ibm.com/docs/containers?topic=containers-storage-cos-understand#create_cos_secret).
