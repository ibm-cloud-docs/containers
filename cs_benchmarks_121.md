...
| 1.2.21 | IKS enables [profiling](https://kubernetes.io/docs/reference/command-line-tools-reference/kube-apiserver/){: external} for cluster administrator troubleshooting purposes. |
