...
<dl>
  ...
  <dt>Cluster overview page in {{site.data.keyword.Bluemix_notm}} (deprecated)</dt>
  ...
  <p class="deprecated">The link to the metrics dashboard in the cluster overview page of the {{site.data.keyword.Bluemix_notm}} console and in the output of `ibmcloud ks cluster-get` is deprecated. Clusters created after 02 May 2019 are not created with the metrics dashboard link. Clusters created on or before 02 May 2019 continue to have the link to the metrics dashboard.</p></dd>
