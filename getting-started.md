  ...
  <div class="solutionBox">
   <a href = "#vpc-classic-gs">
    <div>
         ...
         <p class="bx--type-caption" style="margin: 10px 10px 10px 10px;">Create your cluster in a Virtual Private Cloud (VPC) for Gen 1 compute resources that gives you the security of a private cloud with the dynamic scalability of a public cloud. Control network traffic with security groups and access control lists.   </p>
     </div>
    </a>
</div>
    </div>
