...
## Change log for version 2.2.53, released 25 May 2026
{: #02253_object_plugin}
...
- Adds support for the `in-mum` region.
- Resolves [CVE-2026-33186](https://exchange.xforce.ibmcloud.com/vulnerabilities/CVE-2026-33186){: external}.
