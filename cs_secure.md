...
For more information about service endpoints, see [Service endpoints for worker-to-master and user-to-master communication](/docs/containers?topic=containers-cs_network_ov#cs_network_ov_master)<staging>(/docs/containers?topic=containers-plan_clusters#comm-master)<staging>.
