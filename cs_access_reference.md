...
| View a list of available flavors for your worker nodes. | [`ibmcloud ks flavors`](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#cs_machine_types) (machine-types) | [`GET /v1/datacenters/{datacenter}/machine-types`](https://containers.cloud.ibm.com/global/swagger-global-api/#/util/GetDatacenterMachineTypes) |
