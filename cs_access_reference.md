...
| List available VPC subnets. | [`ibmcloud ks subnets`](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#cs_subnets) | [`GET /v2/vpc/getSubnets`](https://containers.cloud.ibm.com/swagger-api/#/vpc/getSubnets) |
...
| List all VPCs in the targeted resource group. | [`ibmcloud ks vpcs`](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#cs_vpcs) | [`GET /v2​/vpc​/getVPCs`](https://containers.cloud.ibm.com/swagger-api/#/vpc/getVPCs) |
...
| Create a worker pool in a VPC cluster. | [`ibmcloud ks worker-pool-create-vpc-classic`](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#cli_worker-pool-create-vpc-classic) | [`POST ​/v2​/vpc​/createWorkerPool`](https://containers.cloud.ibm.com/swagger-api/#/vpc/vpcCreateWorkerPool) |
...
| Add a zone to a worker pool. | [`ibmcloud ks zone-add-vpc-classic`](/docs/containers?topic=containers-cli-plugin-kubernetes-service-cli#cli_zone-add-vpc-classic) | [`POST ​/v2​/vpc​/createWorkerPoolZone`](https://containers.cloud.ibm.com/swagger-api/#/vpc/vpcCreateWorkerPoolZone) |
