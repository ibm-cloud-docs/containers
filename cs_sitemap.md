...
* [Trying out the BookInfo sample app](/docs/containers?topic=containers-istio-mesh#istio_bookinfo)
  ...
  * [Exposing BookInfo by using an IBM-provided subdomain](/docs/containers?topic=containers-istio-mesh#istio_expose_bookinfo)
...
* [Exposing Istio-managed apps by using an IBM-provided subdomain](/docs/containers?topic=containers-istio-mesh#istio_expose)
