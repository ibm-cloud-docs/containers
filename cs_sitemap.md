...
* [Using an image pull secret to access other Kubernetes namespaces, other {{site.data.keyword.cloud_notm}} accounts, or external private registries](/docs/containers?topic=containers-registry#other)
  ...
  * [Creating an image pull secret to access images in other {{site.data.keyword.cloud_notm}} accounts or to use IAM policies to restrict registry access](/docs/containers?topic=containers-registry#other_registry_accounts)
