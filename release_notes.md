...
| Date | Description |
| ---- | ----------- |
| XX December 2019 | <ul><roks311-vpc><li>**Configuring VPC subnets**: [Added information](/docs/containers?topic=containers-vpc-subnets) about configuring VPC subnets, public gateways, and network segmentation for your VPC clusters.</li></roks311-vpc></ul>|
