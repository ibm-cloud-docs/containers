...
| Date | Description |
| ---- | ----------- |
| 27 August 2020 | <ul><li>**Observability CLI plug-in**: Added the following commands to manage your {{site.data.keyword.la_full_notm}} and {{site.data.keyword.mon_full_notm}} configurations: [`ibmcloud ob logging agent discover`](#logging_agent_discover), [`ibmcloud ob logging config enable public-endpoint|private-endpoint`](#logging_config_enable), [`ibmcloud ob logging config show`](#logging_config_show), [`ibmcloud ob monitoring agent discover`](#monitoring_agent_discover), and [`ibmcloud ob monitoring config enable public-endpoint|private-endpoint`](#monitoring_config_enable).</li></ul>
