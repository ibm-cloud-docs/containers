...
| Date | Description |
| ---- | ----------- |
| 15 June 2021 | <ul><li>**New! Private VPC NLB**: You can now create [private Network Load Balancers for VPC](/docs/containers?topic=containers-vpc-lbaas#setup_vpc_nlb_priv) to expose apps in clusters that run Kubernetes version 1.19 and later.</li></ul> |
