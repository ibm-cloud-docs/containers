...
| Date | Description |
| ---- | ----------- |
| 24 August 2020 | The [cluster autoscaler](/docs/containers?topic=containers-ca) is available as a managed add-on. The cluster autoscaler Helm chart is deprecated. Migrate your autoscaled worker pools to use the add-on. |
