...
<tr>
  ...
  <td><strong>Forwarding Kubernetes API audit logs to {{site.data.keyword.at_full_notm}}</strong>: Added steps [create an audit webhook in your cluster](docs/containers?topic=containers-health#webhook_at) to collect Kubernetes API audit logs from your cluster and forward them to {{site.data.keyword.at_full_notm}}.</td>
</tr>
<tr>
