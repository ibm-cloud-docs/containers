...
| Date | Description |
| ---- | ----------- |
| 04 February 2021 | <ul><li>**CLI changelog**: Updated the {{site.data.keyword.containerlong_notm}} CLI plug-in changelog page for the [release of version 1.0.223](/docs/containers?topic=containers-cs_cli_changelog#10).</li><li>**Worker node modifications**: Summarized the modifications that you can make to the [default worker node settings](/docs/containers?topic=containers-kernel#worker-default).</li></ul>|
