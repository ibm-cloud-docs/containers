...
| Date | Description |
| ---- | ----------- |
| 11 December 2020 | <ul><li>**strongSwan versions** Added information about which [strongSwan Helm chart versions](/docs/containers?topic=containers-vpn#vpn_upgrade) are supported.</li></ul> |
