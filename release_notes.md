...
| Date | Description |
| ---- | ----------- |
| 01 June 2020 | <ul><li>**VPC ACLs**: Added required rules for using VPC load balancers to steps for [Creating access control lists (ACLs) to control traffic to and from your VPC cluster](#acls).</li></ul>|
