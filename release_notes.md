...
| Date | Description |
| ---- | ----------- |
| 14 February 2020 | <ul><li>**Istio add-on**: [Version 1.4.4 of the Istio managed add-on](/docs/containers?topic=containers-istio-changelog#144) is released.</li><li>****: </li></ul> |
