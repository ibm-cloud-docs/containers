...
| Date | Description |
| ---- | ----------- |
| 06 January 2021 | <ul><li>**Ingress ALB changelog**: Updated the latest [Kubernetes Ingress image build to `0.35.0_869_iks`](/docs/containers?topic=containers-cluster-add-ons-changelog#0_35_0).</li></ul>|
