...
| Date | Description |
| ---- | ----------- |
| 27 July 2020 | <ul><li>**Ingress ALB versions**: Added the `ibmcloud ks alb versions` CLI command to show the available versions for the ALBs in your cluster and the `ibmcloud ks alb update` CLI command to update or rollback ALBs to a specific version.</li></ul> |
