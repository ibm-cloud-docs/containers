...
| Date | Description |
| ---- | ----------- |
| 30 March 2020 | **Version changelogs**: Worker node patch updates are available for Kubernetes [1.17.3_1520](/docs/containers?topic=containers-changelog#1174_1520), [1.16.7_1527](/docs/containers?topic=containers-changelog#1168_1527), [1.15.10_1534](/docs/containers?topic=containers-changelog#11511_1534), and [1.14.10_1550](/docs/containers?topic=containers-changelog##11410_1550). |
