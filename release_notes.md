...
| Date | Description |
| ---- | ----------- |
| 26 May 2021 | <ul><li>**CLI changelog**: Updated the {{site.data.keyword.containerlong_notm}} CLI plug-in changelog page for the [release of version 1.0.275](/docs/containers?topic=containers-cs_cli_changelog#10).</li></ul> |
