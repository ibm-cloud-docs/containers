...
<tr>
  ...
  <li><strong>Troubleshooting storage</strong>: <ul>
  <li>Added a topic for [debugging persistent storage failures](/docs/containers?topic=containers-debug_storage).</li>
