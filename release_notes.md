...
| Date | Description |
| ---- | ----------- |
| 12 July 2021| **Snapshots**: Before updating to Kubernetes master version `1.20` or `1.21`, Snapshot CRDs must be updated or downgraded to version `1beta1`. For more information, see the [Kubernetes version information and update actions](docs/containers?topic=containers-cs_versions#121_before).
