...
| 1.3.6 | Ensure that the RotateKubeletServerCertificate argument is set to true | Scored | 2 | [Fail](#ibm-remediations-and-explanations) | IBM |
...
| 4.2.11 | Ensure that the --rotate-certificates argument is not set to false | Scored | 1 | [Pass](#ibm-remediations-and-explanations) | IBM |
| 4.2.12 | Ensure that the RotateKubeletServerCertificate argument is set to true | Scored | 1 | [Fail](#ibm-remediations-and-explanations) | IBM |
