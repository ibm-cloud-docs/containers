...
With {{site.data.keyword.containerlong_notm}}, you can create your cluster of compute hosts on classic {{site.data.keyword.cloud_notm}} infrastructure, VPC Gen 1 compute infrastucture, or VPC Gen 2 compute infrastructure.
