...
Learn more about [{{site.data.keyword.containerlong_notm}}](https://www.ibm.com/cloud/container-service){: external}, its capabilities and the options that are available to you to customize the cluster to your needs.
{: shortdesc}
...
With {{site.data.keyword.containerlong_notm}}, you can create your cluster of compute hosts on classic {{site.data.keyword.cloud_notm}} infrastructure, VPC Gen 1 compute infrastructure,  or VPC Gen 2 compute infrastucture.
