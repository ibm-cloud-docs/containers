...
For more information on securing your cluster, see [Security for {{site.data.keyword.containerlong_notm}}](/docs/containers?topic=containers-security#security).
...
### Accessing your registry with credentials stored in a Kubernetes image pull secret
{: #imagepullsecret}
...
To get started, provision an SGX-enabled bare metal worker cluster with machine type: mb2c.4x32 and check out the [the {{site.data.keyword.datashield_short}} docs](/docs/services/data-shield?topic=data-shield-getting-started).
