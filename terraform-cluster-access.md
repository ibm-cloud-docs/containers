...
Before you begin, make sure that you have the [required access](/docs/containers?topic=containers-iam-platform-access-roles) to create and work with {{site.data.keyword.containerlong_notm}} resources. 
