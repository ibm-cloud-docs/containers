...
Looking for information about scaling Cloud Foundry applications? Check out [IBM Auto-Scaling for {{site.data.keyword.Bluemix_notm}}](/docs/services/Auto-Scaling/index.html). Want to scale your worker nodes instead of your pods? Check out the [cluster autoscaler (beta)](cs_cluster_scaling.html#ca).
{: tip}
