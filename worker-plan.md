...
![Classic infrastructure provider icon.](images/icon-classic-2.svg) Software-defined storage flavor are available for classic clusters only and are not supported in VPC clusters.
{: note}
