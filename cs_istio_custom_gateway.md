...
spec:
  profile: empty
  hub: icr.io/ext/istio
  # tag: 1.20.0 # Force the gateway to a specific managed Istio version
  components:
    ingressGateways:
      - name: custom-ingressgateway
        label:
...
spec:
  profile: empty
  hub: icr.io/ext/istio
  # tag: 1.20.0 # Force the Gateway to a specific version
  components:
    egressGateways:
