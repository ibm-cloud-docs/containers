...
With version 2.0.9, there is a new version of the `ibmc` plug-in. Storage classes that were created with earlier chart versions are immutable and can't be upgraded. To install the latest storage classes in your cluster, uninstall and re-install the {{site.data.keyword.cos_full_notm}} plug-in. For more information, see [Updating the {{site.data.keyword.cos_full_notm}}](/docs/containers?topic=containers-object_storage#update_cos_plugin).
{: note}
...
| -------------------- | -----------|--------------------------- |
| 2.1.2 | <img src="images/icon-checkmark-confirm.svg" width="32" alt="Supported" style="width:32px;" /> | Kubernetes > 1.10 | x86 |
| 2.1.1 | <img src="images/icon-checkmark-confirm.svg" width="32" alt="Supported" style="width:32px;" /> | Kubernetes 1.10 to 1.20 | x86 |
| 2.1.0 | <img src="images/icon-checkmark-confirm.svg" width="32" alt="Supported" style="width:32px;" /> | Kubernetes 1.10 to 1.20 | x86 |
| 2.0.9 | <img src="images/icon-checkmark-confirm.svg" width="32" alt="Supported" style="width:32px;" /> | Kubernetes 1.10 to 1.20 | x86 |
| 2.0.8 | <img src="images/icon-checkmark-confirm.svg" width="32" alt="Supported" style="width:32px;" /> | Kubernetes 1.10 to 1.20 | x86 |
| 2.0.7 | <img src="images/icon-checkmark-confirm.svg" width="32" alt="Supported" style="width:32px;" /> | Kubernetes 1.10 to 1.20 | x86 |
| 2.0.6 | <img src="images/icon-checkmark-confirm.svg" width="32" alt="Supported" style="width:32px;" /> | Kubernetes 1.10 to 1.20 | x86 | 
| 2.0.5 | <img src="images/icon-checkmark-confirm.svg" width="32" alt="Supported" style="width:32px;" /> | Kubernetes 1.10 to 1.20 | x86 |
...
| --- | --- | --- | --- |
| `2.1.2` | `1.8.30` | 22 June 2021 | Updates in this version: <ul><li>Version `v2.0.5` of the `helm-ibmc` plug-in is available.</li><li>Fixes [`CVE-2021-31525`](https://nvd.nist.gov/vuln/detail/CVE-2021-31525){: external},[`CVE-2021-33194`](https://nvd.nist.gov/vuln/detail/CVE-2021-33194){: external}, and [`CVE-2021-27219`](https://nvd.nist.gov/vuln/detail/CVE-2021-27219){: external}.</li></ul> |
{: row-headers}
