...
Looking for `ic cr` commands? See the [{{site.data.keyword.registryshort_notm}} CLI reference](/docs/cli/plugins/registry/index.html). Looking for `kubectl` commands? See the [Kubernetes documentation ![External link icon](../icons/launch-glyph.svg "External link icon")](https://kubernetes.io/docs/reference/kubectl/overview/).
{:tip}
...
<col width="25%">
 ...
 <tbody>
    <tr>
      ...
      <td>[ic cs worker-reload](#cs_worker_reload)</td>
    </tr>
    <tr>
...
### ic cs api ENDPOINT [--insecure] [--skip-ssl-validation] [--api-version VALUE] [-s]
{: #cs_api}
...
Switching regions? Use the `ic cs region-set` [command](#cs_region-set) instead.
{: tip}
...
### ic cs api-key-info CLUSTER [--json] [-s]
{: #cs_api_key_info}
...
### ic cs apiserver-refresh CLUSTER [-s]
...
### ic cs init [--host HOST] [--insecure] [-p] [-u] [-s]
{: #cs_init}
...
### ic cs cluster-config CLUSTER [--admin] [--export] [-s] [--yaml]
{: #cs_cluster_config}
...
### ic cs cluster-create [--file FILE_LOCATION] [--hardware HARDWARE] --location LOCATION --machine-type MACHINE_TYPE --name NAME [--kube-version MAJOR.MINOR.PATCH] [--no-subnet] [--private-vlan PRIVATE_VLAN] [--public-vlan PUBLIC_VLAN] [--workers WORKER] [--disable-disk-encrypt] [--trusted] [-s]
{: #cs_cluster_create}
...
### ic cs cluster-feature-enable [-f] CLUSTER [--trusted] [-s]
...
### ic cs cluster-get CLUSTER [--json] [--showResources] [-s]
{: #cs_cluster_get}
...
### ic cs cluster-update [-f] CLUSTER [--kube-version MAJOR.MINOR.PATCH] [--force-update] [-s]
{: #cs_cluster_update}
...
### ic cs cluster-service-bind CLUSTER KUBERNETES_NAMESPACE SERVICE_INSTANCE_NAME [-s]
...
### ic cs cluster-service-unbind CLUSTER KUBERNETES_NAMESPACE SERVICE_INSTANCE_GUID [-s]
...
### ic cs cluster-services CLUSTER [--namespace KUBERNETES_NAMESPACE] [--all-namespaces] [--json] [-s]
{: #cs_cluster_services}
...
### ic cs va CONTAINER_ID [--extended] [--vulnerabilities] [--configuration-issues] [--json]
{: #cs_va}
...
```
ic cs va 1a11a1aa2b2b22223333c44444ccc555667d7dd777888e8ef99f1011121314g15 --extended --vulnerabilities --json
```
{: pre}


### ic cs webhook-create --cluster CLUSTER --level LEVEL --type slack --url URL  [-s]
{: #cs_webhook_create}
...
### ic cs cluster-subnet-add CLUSTER SUBNET [-s]
...
### ic cs cluster-subnet-create CLUSTER SIZE VLAN_ID [-s]
...
### ic cs alb-cert-deploy [--update] --cluster CLUSTER --secret-name SECRET_NAME --cert-crn CERTIFICATE_CRN [-s]
{: #cs_alb_cert_deploy}
...
### ic cs alb-cert-get --cluster CLUSTER [--secret-name SECRET_NAME] [--cert-crn CERTIFICATE_CRN] [--json] [-s]
{: #cs_alb_cert_get}
...
### ic cs alb-cert-rm --cluster CLUSTER [--secret-name SECRET_NAME] [--cert-crn CERTIFICATE_CRN] [-s]
{: #cs_alb_cert_rm}
...
### ic cs alb-certs --cluster CLUSTER [--json] [-s]
{: #cs_alb_certs}
...
### ic cs alb-configure --albID ALB_ID [--enable][--disable][--user-ip USERIP] [-s]
{: #cs_alb_configure}
...
### ic cs alb-get --albID ALB_ID [--json] [-s]
{: #cs_alb_get}
...
### ic cs albs --cluster CLUSTER [--json] [-s]
{: #cs_albs}
...
### ic cs credentials-set --infrastructure-api-key API_KEY --infrastructure-username USERNAME [-s]
{: #cs_credentials_set}
...
### ic cs vlans LOCATION [--all] [--json] [-s]
{: #cs_vlans}
...
### ic cs logging-config-create CLUSTER --logsource LOG_SOURCE --type LOG_TYPE [--namespace KUBERNETES_NAMESPACE] [--hostname LOG_SERVER_HOSTNAME_OR_IP] [--port LOG_SERVER_PORT] [--space CLUSTER_SPACE] [--org CLUSTER_ORG] [--app-containers CONTAINERS] [--app-paths PATHS_TO_LOGS] [--syslog-protocol PROTOCOL]  [--json] [--skip-validation] [-s]
{: #cs_logging_create}
...
### ic cs logging-config-get CLUSTER [--logsource LOG_SOURCE] [--json] [-s]
{: #cs_logging_get}
...
### ic cs logging-config-refresh CLUSTER [-s]
{: #cs_logging_refresh}
...
### ic cs logging-config-rm CLUSTER [--id LOG_CONFIG_ID] [--all] [-s]
{: #cs_logging_rm}
...
### ic cs logging-config-update CLUSTER --id LOG_CONFIG_ID --type LOG_TYPE  [--namespace NAMESPACE] [--hostname LOG_SERVER_HOSTNAME_OR_IP] [--port LOG_SERVER_PORT] [--space CLUSTER_SPACE] [--org CLUSTER_ORG] [--app-paths PATH] [--app-containers PATH] [--json] [--skipValidation] [-s]
{: #cs_logging_update}
...
### ic cs logging-filter-create CLUSTER --type LOG_TYPE [--logging-configs CONFIGS] [--namespace KUBERNETES_NAMESPACE] [--container CONTAINER_NAME] [--level LOGGING_LEVEL] [--regex-message MESSAGE] [--json] [-s]
...
### ic cs logging-filter-get CLUSTER [--id FILTER_ID] [--show-matching-configs] [--show-covering-filters] [--json] [-s]
{: #cs_log_filter_view}
...
### ic cs logging-filter-rm CLUSTER [--id FILTER_ID] [--all] [-s]
...
### ic cs logging-filter-update CLUSTER --id FILTER_ID --type LOG_TYPE [--logging-configs CONFIGS] [--namespace KUBERNETES_NAMESPACE] [--container CONTAINER_NAME] [--level LOGGING_LEVEL] [--message MESSAGE] [--json] [-s]
...
### ic cs locations [--json] [-s]
{: #cs_datacenters}

View a list of available locations for you to create a cluster in. The available locations vary by the region that you are logged in to. To switch regions, run `ic cs region-set`.
...
###  ic cs worker-add --cluster CLUSTER [--file FILE_LOCATION] [--hardware HARDWARE] --machine-type MACHINE_TYPE --workers NUMBER --private-vlan PRIVATE_VLAN --public-vlan PUBLIC_VLAN [--disable-disk-encrypt] [-s]
{: #cs_worker_add}
...
### ic cs worker-get [CLUSTER_NAME_OR_ID] WORKER_NODE_ID [--json] [-s]
{: #cs_worker_get}
...
### ic cs worker-reboot [-f] [--hard] CLUSTER WORKER [WORKER] [-s]
{: #cs_worker_reboot}
...
### ic cs worker-reload [-f] CLUSTER WORKER [WORKER] [-s]
{: #cs_worker_reload}
...
### ic cs worker-rm [-f] CLUSTER WORKER [WORKER] [-s]
{: #cs_worker_rm}
...
### ic cs worker-update [-f] CLUSTER WORKER [WORKER] [--kube-version MAJOR.MINOR.PATCH] [--force-update] [-s]
{: #cs_worker_update}
...
### ic cs workers CLUSTER [--show-deleted] [--json] [-s]
{: #cs_workers}
...
**Example**:
  ...
  ```
  ic cs worker-pool-rebalance --cluster my_cluster --worker-pool my_pool
  ```
  {: pre}

### ic cs worker-pool-resize --worker-pool WORKER_POOL --cluster CLUSTER --size-per-zone WORKERS_PER_ZONE [-s]
...
**Example command**:
  ...
  ```
  ic cs worker-pool-update --cluster my_cluster --worker-pool my_pool --size-per-zone 3
  ```
  {: pre}

### ic cs worker-pool-rm --worker-pool WORKER_POOL --cluster CLUSTER [--json] [-s]
{: #cs_worker_pool_rm}
...
**Example command**:
  ...
  ```
  ic cs worker-pool-rm --cluster my_cluster --worker-pool pool1
  ```
  {: pre}

### ic cs worker-pool-update --worker-pool WORKER_POOL --cluster CLUSTER [-f] [-s]
...
**Example command**:
  ...
  ```
  ic cs worker-pool-update --worker-pool pool1 --cluster my_cluster
  ```
  {: pre}

### ic cs worker-pools --cluster CLUSTER [--json] [-s]
{: #cs_worker_pools}
...
**Example command**:
  ...
  ```
  ic cs worker-pools --cluster my_cluster
  ```
  {: pre}

### ic cs zone-add --zone ZONE --cluster CLUSTER --worker-pools WORKER_POOL1,[WORKER_POOL2] --private-vlan PRIVATE_VLAN [--public-vlan PUBLIC_VLAN] [--json] [-s]
{: #cs_zone_add}
...
<dl>
  ...
  <dt><code>--private-vlan <em>PRIVATE_VLAN</em></code></dt>
    <dd>The ID of the private VLAN. This value is required. It must match the private VLAN ID of one or more of the worker nodes in the cluster. To see the VLANs that you have available, run <code>ic cs cluster-get --cluster &lt;cluster&gt; --showResources</code>. If you do not have a private or public VLAN in that zone, do not specify this option. A private and a public VLAN are automatically created for you when you initially add a new zone to your worker pool. Then, <a href="/docs/infrastructure/vlans/vlan-spanning.html#enable-or-disable-vlan-spanning" >enable VLAN spanning</a> for your account so that worker nodes in different zones can communicate with each other. 
<br><br>**Note**: New worker nodes are added to the VLANs that you specify, but the VLANs for any existing worker nodes are not changed.</dd>
  ...
  <dt><code>--public-vlan <em>PUBLIC_VLAN</em></code></dt>
    <dd>The ID of the public VLAN. This value is required if you want to expose workloads on the nodes to the public. It must match the public VLAN ID of one or more of the worker nodes in the cluster. To see the VLANs that you have available, run <code>ic cs cluster-get --cluster &lt;cluster&gt; --showResources</code>. If you do not have a private or public VLAN in that zone, do not specify this option. A private and a public VLAN are automatically created for you when you initially add a new zone to your worker pool. Then, <a href="/docs/infrastructure/vlans/vlan-spanning.html#enable-or-disable-vlan-spanning" >enable VLAN spanning</a> for your account so that worker nodes in different zones can communicate with each other.<br><br>**Note**: New worker nodes are added to the VLANs that you specify, but the VLANs for any existing worker nodes are not changed.</dd>
...
**Example**:
  ...
  ```
  ic cs zone-add --zone dal10 --cluster my_cluster --worker-pools pool1,pool2,pool3 --private-vlan 2294021
  ```
  {: pre}

  ### ic cs zone-network-set --zone ZONE --cluster CLUSTER --worker-pools WORKER_POOL1,[WORKER_POOL2] --private-vlan PRIVATE_VLAN [--public-vlan PUBLIC_VLAN] [--json] [-s]
  {: #cs_zone_network_set}
  ...
  **Multizone clusters only**: Set the network metadata for a worker pool to use a different public or private VLAN for the zone than it previously used. Worker nodes that were already created in the pool continue to use the previous public or private VLAN, but new worker nodes in the pool use the new network data.
  ...
  <dt><code>--private-vlan <em>PRIVATE_VLAN</em></code></dt>
    <dd>The ID of the private VLAN. This value is required. It must match the private VLAN ID of one or more of the worker nodes in the cluster. To see the VLANs that you have available, run <code>ic cs cluster-get --cluster &lt;cluster&gt; --showResources</code>. If you do not have any VLANs available, you can <a href="/docs/infrastructure/vlans/vlan-spanning.html#enable-or-disable-vlan-spanning" >enable VLAN spanning</a> for your account.<br><br>**Note**: New worker nodes are added to the VLANs that you specify, but the VLANs for any existing worker nodes are not changed.</dd>

  <dt><code>--public-vlan <em>PUBLIC_VLAN</em></code></dt>
    <dd>The ID of the public VLAN. This value is required if you want to change the public VLAN for the zone. If you do not want to change the private VLAN with the public VLAN, use the same private VLAN ID. The public VLAN ID must match the public VLAN ID of one or more of the worker nodes in the cluster. To see the VLANs that you have available, run <code>ic cs cluster-get --cluster &lt;cluster&gt; --showResources</code>. If you do not have any VLANs available, you can <a href="/docs/infrastructure/vlans/vlan-spanning.html#enable-or-disable-vlan-spanning" >enable VLAN spanning</a> for your account.<br><br>**Note**: New worker nodes are added to the VLANs that you specify, but the VLANs for any existing worker nodes are not changed.</dd>
  ...
  **Example**:
  ...
  ```
  ic cs zone-network-set --zone dal10 --cluster my_cluster --worker-pools pool1,pool2,pool3 --private-vlan 2294021
  ```
  {: pre}

### ic cs zone-rm --zone ZONE --cluster CLUSTER [-f] [-s]
{: #cs_zone_rm}
...
**Example**:
  ...
  ```
  ic cs zone-rm --zone dal10 --cluster my_cluster
  ```
  {: pre}
