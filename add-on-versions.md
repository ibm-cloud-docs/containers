...
- Supported OpenShift cluster versions: `>=4.20.0 <4.22.0`
...
- Supported Kubernetes cluster versions: `>=1.19.0 <1.37.0`
...
- Supported Kubernetes cluster versions: `>=1.28.0 <1.35.0`

- Supported OpenShift cluster versions: `>=4.15.0 <4.22.0`



## `cluster-autoscaler` 2.0.0 
{: #cluster-autoscaler-2.0.0}

- Supported Kubernetes cluster versions: `>=1.31.0 <1.36.0`

- Supported OpenShift cluster versions: `>=4.17.0 <4.22.0`
...
- Supported Kubernetes cluster versions: `>=1.20.0 <1.37.0`

- Supported OpenShift cluster versions: `>=4.6.0 <4.22.0`
...
- Supported Kubernetes cluster versions: `>=1.29.0 <1.37.0`

- Supported OpenShift cluster versions: `>=4.14.0 <4.22.0`
...
- Supported OpenShift cluster versions: `>=4.4.0 <4.22.0`
...
- Supported Kubernetes cluster versions: `>=1.31.0 <1.34.0`
...
- Supported Kubernetes cluster versions: `>=1.31.0 <1.35.0`
...
- Supported Kubernetes cluster versions: `>=1.32.0 <1.37.0`
...
- Supported OpenShift cluster versions: `>=4.19.0 <4.22.0`
...
## `openshift-data-foundation` 4.19.0 
{: #openshift-data-foundation-4.19.0}
...
## `openshift-data-foundation` 4.20.0 
{: #openshift-data-foundation-4.20.0}
...
- Supported OpenShift cluster versions: `>=4.21.0 <4.22.0`
...
- Supported Kubernetes cluster versions: `>=1.26.0 <1.37.0`

- Supported OpenShift cluster versions: `>=4.11.0 <4.22.0`
...
- Supported Kubernetes cluster versions: `>=1.22.0 <1.37.0`

- Supported OpenShift cluster versions: `>=4.9.0 <4.22.0`
...
- Supported Kubernetes cluster versions: `>=1.25.0 <1.37.0`

- Supported OpenShift cluster versions: `>=4.10.0 <4.22.0`
