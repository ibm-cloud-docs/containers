...
- Supported Kubernetes cluster versions: `>=1.28.0 <1.33.0`
...
- Supported OpenShift cluster versions: `>=4.11.0 <4.19.0`
...
- Supported OpenShift cluster versions: `>=4.9.0 <4.19.0`
