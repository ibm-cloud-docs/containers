...
3. Configure disaster recovery for your cluster. 
    **Metro DR**:
    ...
    4. Optional: Decide if you want to set up [encryption for your Portworx volumes](/docs/containers?topic=containers-storage_portworx_encyrption).
    ...
    **Asynchronous DR**:
    ...
    4. Enable Portworx [volume encryption](/docs/containers?topic=containers-storage_portworx_encyrption) for both of your clusters. The {{site.data.keyword.keymanagementservicelong_notm}} credentials are later used by Portworx to encrypt data traffic between the clusters.
