...
5.  Create the Kubernetes secret to store your token information.
    ...
    <td>Required. The user name to log in to your private registry. For {{site.data.keyword.registryshort_notm}}, the user name is set to the value <strong>token</strong>.</td>
    </tr>
    <tr>
...
2.  Define the pod and the imagePullSecret to access the private {{site.data.keyword.registrylong_notm}}.
    ...
    <td>The namespace where the image is stored. To list available namespaces, run `bx cr namespace-list`.</td>
    </tr>
    <tr>
